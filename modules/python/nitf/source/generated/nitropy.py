...
_nitropy.NRT_LIB_VERSION_swigconstant(_nitropy)
NRT_LIB_VERSION = _nitropy.NRT_LIB_VERSION

_nitropy.NRT_FILE_swigconstant(_nitropy)
NRT_FILE = _nitropy.NRT_FILE

_nitropy.NRT_LINE_swigconstant(_nitropy)
NRT_LINE = _nitropy.NRT_LINE

_nitropy.NRT_FUNC_swigconstant(_nitropy)
NRT_FUNC = _nitropy.NRT_FUNC

_nitropy.NRT_DEFAULT_PERM_swigconstant(_nitropy)
NRT_DEFAULT_PERM = _nitropy.NRT_DEFAULT_PERM

_nitropy.NRT_INVALID_HANDLE_VALUE_swigconstant(_nitropy)
NRT_INVALID_HANDLE_VALUE = _nitropy.NRT_INVALID_HANDLE_VALUE

_nitropy.NRT_OPEN_EXISTING_swigconstant(_nitropy)
NRT_OPEN_EXISTING = _nitropy.NRT_OPEN_EXISTING

_nitropy.NRT_MAX_PATH_swigconstant(_nitropy)
NRT_MAX_PATH = _nitropy.NRT_MAX_PATH

_nitropy.NRT_SUCCESS_swigconstant(_nitropy)
NRT_SUCCESS = _nitropy.NRT_SUCCESS

_nitropy.NRT_FAILURE_swigconstant(_nitropy)
NRT_FAILURE = _nitropy.NRT_FAILURE

_nitropy.NRT_TRUE_swigconstant(_nitropy)
NRT_TRUE = _nitropy.NRT_TRUE

_nitropy.NRT_FALSE_swigconstant(_nitropy)
NRT_FALSE = _nitropy.NRT_FALSE

_nitropy.NRT_CORNERS_UNKNOWN_swigconstant(_nitropy)
NRT_CORNERS_UNKNOWN = _nitropy.NRT_CORNERS_UNKNOWN

_nitropy.NRT_CORNERS_UTM_swigconstant(_nitropy)
NRT_CORNERS_UTM = _nitropy.NRT_CORNERS_UTM

_nitropy.NRT_CORNERS_UTM_UPS_S_swigconstant(_nitropy)
NRT_CORNERS_UTM_UPS_S = _nitropy.NRT_CORNERS_UTM_UPS_S

_nitropy.NRT_CORNERS_UTM_UPS_N_swigconstant(_nitropy)
NRT_CORNERS_UTM_UPS_N = _nitropy.NRT_CORNERS_UTM_UPS_N

_nitropy.NRT_CORNERS_GEO_swigconstant(_nitropy)
NRT_CORNERS_GEO = _nitropy.NRT_CORNERS_GEO

_nitropy.NRT_CORNERS_DECIMAL_swigconstant(_nitropy)
...
_nitropy.NITF_LIB_VERSION_swigconstant(_nitropy)
NITF_LIB_VERSION = _nitropy.NITF_LIB_VERSION

_nitropy.NITF_VER_20_swigconstant(_nitropy)
NITF_VER_20 = _nitropy.NITF_VER_20

_nitropy.NITF_VER_21_swigconstant(_nitropy)
NITF_VER_21 = _nitropy.NITF_VER_21

_nitropy.NITF_VER_UNKNOWN_swigconstant(_nitropy)
NITF_VER_UNKNOWN = _nitropy.NITF_VER_UNKNOWN

_nitropy.NRT_MAX_EMESSAGE_swigconstant(_nitropy)
NRT_MAX_EMESSAGE = _nitropy.NRT_MAX_EMESSAGE

_nitropy.NRT_NO_ERR_swigconstant(_nitropy)
NRT_NO_ERR = _nitropy.NRT_NO_ERR

_nitropy.NRT_ERR_MEMORY_swigconstant(_nitropy)
NRT_ERR_MEMORY = _nitropy.NRT_ERR_MEMORY

_nitropy.NRT_ERR_OPENING_FILE_swigconstant(_nitropy)
NRT_ERR_OPENING_FILE = _nitropy.NRT_ERR_OPENING_FILE

_nitropy.NRT_ERR_READING_FROM_FILE_swigconstant(_nitropy)
NRT_ERR_READING_FROM_FILE = _nitropy.NRT_ERR_READING_FROM_FILE

_nitropy.NRT_ERR_SEEKING_IN_FILE_swigconstant(_nitropy)
NRT_ERR_SEEKING_IN_FILE = _nitropy.NRT_ERR_SEEKING_IN_FILE

_nitropy.NRT_ERR_WRITING_TO_FILE_swigconstant(_nitropy)
NRT_ERR_WRITING_TO_FILE = _nitropy.NRT_ERR_WRITING_TO_FILE

_nitropy.NRT_ERR_STAT_FILE_swigconstant(_nitropy)
NRT_ERR_STAT_FILE = _nitropy.NRT_ERR_STAT_FILE

_nitropy.NRT_ERR_LOADING_DLL_swigconstant(_nitropy)
NRT_ERR_LOADING_DLL = _nitropy.NRT_ERR_LOADING_DLL

_nitropy.NRT_ERR_UNLOADING_DLL_swigconstant(_nitropy)
NRT_ERR_UNLOADING_DLL = _nitropy.NRT_ERR_UNLOADING_DLL

_nitropy.NRT_ERR_RETRIEVING_DLL_HOOK_swigconstant(_nitropy)
NRT_ERR_RETRIEVING_DLL_HOOK = _nitropy.NRT_ERR_RETRIEVING_DLL_HOOK

_nitropy.NRT_ERR_UNINITIALIZED_DLL_READ_swigconstant(_nitropy)
NRT_ERR_UNINITIALIZED_DLL_READ = _nitropy.NRT_ERR_UNINITIALIZED_DLL_READ

_nitropy.NRT_ERR_INVALID_PARAMETER_swigconstant(_nitropy)
NRT_ERR_INVALID_PARAMETER = _nitropy.NRT_ERR_INVALID_PARAMETER

_nitropy.NRT_ERR_INVALID_OBJECT_swigconstant(_nitropy)
NRT_ERR_INVALID_OBJECT = _nitropy.NRT_ERR_INVALID_OBJECT

_nitropy.NRT_ERR_INVALID_FILE_swigconstant(_nitropy)
NRT_ERR_INVALID_FILE = _nitropy.NRT_ERR_INVALID_FILE

_nitropy.NRT_ERR_COMPRESSION_swigconstant(_nitropy)
NRT_ERR_COMPRESSION = _nitropy.NRT_ERR_COMPRESSION

_nitropy.NRT_ERR_DECOMPRESSION_swigconstant(_nitropy)
NRT_ERR_DECOMPRESSION = _nitropy.NRT_ERR_DECOMPRESSION

_nitropy.NRT_ERR_PARSING_FILE_swigconstant(_nitropy)
NRT_ERR_PARSING_FILE = _nitropy.NRT_ERR_PARSING_FILE

_nitropy.NRT_ERR_INT_STACK_OVERFLOW_swigconstant(_nitropy)
NRT_ERR_INT_STACK_OVERFLOW = _nitropy.NRT_ERR_INT_STACK_OVERFLOW

_nitropy.NRT_ERR_UNK_swigconstant(_nitropy)
...
_nitropy.NRT_MAX_READ_ATTEMPTS_swigconstant(_nitropy)
...
_nitropy.NITF_FILE_swigconstant(_nitropy)
NITF_FILE = _nitropy.NITF_FILE

_nitropy.NITF_LINE_swigconstant(_nitropy)
NITF_LINE = _nitropy.NITF_LINE

_nitropy.NITF_FUNC_swigconstant(_nitropy)
NITF_FUNC = _nitropy.NITF_FUNC

_nitropy.NITF_MAX_PATH_swigconstant(_nitropy)
NITF_MAX_PATH = _nitropy.NITF_MAX_PATH

_nitropy.NITF_DEFAULT_PERM_swigconstant(_nitropy)
NITF_DEFAULT_PERM = _nitropy.NITF_DEFAULT_PERM

_nitropy.NITF_INVALID_HANDLE_VALUE_swigconstant(_nitropy)
NITF_INVALID_HANDLE_VALUE = _nitropy.NITF_INVALID_HANDLE_VALUE

_nitropy.NITF_OPEN_EXISTING_swigconstant(_nitropy)
NITF_OPEN_EXISTING = _nitropy.NITF_OPEN_EXISTING

_nitropy.NITF_SUCCESS_swigconstant(_nitropy)
NITF_SUCCESS = _nitropy.NITF_SUCCESS

_nitropy.NITF_FAILURE_swigconstant(_nitropy)
NITF_FAILURE = _nitropy.NITF_FAILURE

_nitropy.NITF_MAX_EMESSAGE_swigconstant(_nitropy)
NITF_MAX_EMESSAGE = _nitropy.NITF_MAX_EMESSAGE

_nitropy.NITF_MAX_READ_ATTEMPTS_swigconstant(_nitropy)
NITF_MAX_READ_ATTEMPTS = _nitropy.NITF_MAX_READ_ATTEMPTS

_nitropy.NITF_DATE_FORMAT_20_swigconstant(_nitropy)
NITF_DATE_FORMAT_20 = _nitropy.NITF_DATE_FORMAT_20

_nitropy.NITF_DATE_FORMAT_21_swigconstant(_nitropy)
NITF_DATE_FORMAT_21 = _nitropy.NITF_DATE_FORMAT_21

_nitropy.NITF_TRE_HASH_SIZE_swigconstant(_nitropy)
NITF_TRE_HASH_SIZE = _nitropy.NITF_TRE_HASH_SIZE

_nitropy.NITF_COMPRESSION_HASH_SIZE_swigconstant(_nitropy)
NITF_COMPRESSION_HASH_SIZE = _nitropy.NITF_COMPRESSION_HASH_SIZE

_nitropy.NITF_DECOMPRESSION_HASH_SIZE_swigconstant(_nitropy)
NITF_DECOMPRESSION_HASH_SIZE = _nitropy.NITF_DECOMPRESSION_HASH_SIZE

_nitropy.NITF_PLUGIN_PATH_swigconstant(_nitropy)
...
_nitropy.NITF_CONV_UINT_swigconstant(_nitropy)
NITF_CONV_UINT = _nitropy.NITF_CONV_UINT

_nitropy.NITF_CONV_INT_swigconstant(_nitropy)
NITF_CONV_INT = _nitropy.NITF_CONV_INT

_nitropy.NITF_CONV_REAL_swigconstant(_nitropy)
NITF_CONV_REAL = _nitropy.NITF_CONV_REAL

_nitropy.NITF_CONV_STRING_swigconstant(_nitropy)
NITF_CONV_STRING = _nitropy.NITF_CONV_STRING

_nitropy.NITF_CONV_RAW_swigconstant(_nitropy)
NITF_CONV_RAW = _nitropy.NITF_CONV_RAW

_nitropy.NITF_INT8_SZ_swigconstant(_nitropy)
NITF_INT8_SZ = _nitropy.NITF_INT8_SZ

_nitropy.NITF_INT16_SZ_swigconstant(_nitropy)
NITF_INT16_SZ = _nitropy.NITF_INT16_SZ

_nitropy.NITF_INT32_SZ_swigconstant(_nitropy)
NITF_INT32_SZ = _nitropy.NITF_INT32_SZ

_nitropy.NITF_INT64_SZ_swigconstant(_nitropy)
NITF_INT64_SZ = _nitropy.NITF_INT64_SZ

_nitropy.NITF_BCS_A_swigconstant(_nitropy)
NITF_BCS_A = _nitropy.NITF_BCS_A

_nitropy.NITF_BCS_N_swigconstant(_nitropy)
NITF_BCS_N = _nitropy.NITF_BCS_N

_nitropy.NITF_BINARY_swigconstant(_nitropy)
...
_nitropy.NITF_CLSY_SZ_swigconstant(_nitropy)
NITF_CLSY_SZ = _nitropy.NITF_CLSY_SZ

_nitropy.NITF_CODE_SZ_swigconstant(_nitropy)
NITF_CODE_SZ = _nitropy.NITF_CODE_SZ

_nitropy.NITF_CTLH_SZ_swigconstant(_nitropy)
NITF_CTLH_SZ = _nitropy.NITF_CTLH_SZ

_nitropy.NITF_REL_SZ_swigconstant(_nitropy)
NITF_REL_SZ = _nitropy.NITF_REL_SZ

_nitropy.NITF_DCTP_SZ_swigconstant(_nitropy)
NITF_DCTP_SZ = _nitropy.NITF_DCTP_SZ

_nitropy.NITF_DCDT_SZ_swigconstant(_nitropy)
NITF_DCDT_SZ = _nitropy.NITF_DCDT_SZ

_nitropy.NITF_DCXM_SZ_swigconstant(_nitropy)
NITF_DCXM_SZ = _nitropy.NITF_DCXM_SZ

_nitropy.NITF_DG_SZ_swigconstant(_nitropy)
NITF_DG_SZ = _nitropy.NITF_DG_SZ

_nitropy.NITF_DGDT_SZ_swigconstant(_nitropy)
NITF_DGDT_SZ = _nitropy.NITF_DGDT_SZ

_nitropy.NITF_CLTX_SZ_swigconstant(_nitropy)
NITF_CLTX_SZ = _nitropy.NITF_CLTX_SZ

_nitropy.NITF_CATP_SZ_swigconstant(_nitropy)
NITF_CATP_SZ = _nitropy.NITF_CATP_SZ

_nitropy.NITF_CAUT_SZ_swigconstant(_nitropy)
NITF_CAUT_SZ = _nitropy.NITF_CAUT_SZ

_nitropy.NITF_CRSN_SZ_swigconstant(_nitropy)
NITF_CRSN_SZ = _nitropy.NITF_CRSN_SZ

_nitropy.NITF_RDT_SZ_swigconstant(_nitropy)
NITF_RDT_SZ = _nitropy.NITF_RDT_SZ

_nitropy.NITF_CTLN_SZ_swigconstant(_nitropy)
NITF_CTLN_SZ = _nitropy.NITF_CTLN_SZ

_nitropy.NITF_SG_BLOCK_SZ_swigconstant(_nitropy)
NITF_SG_BLOCK_SZ = _nitropy.NITF_SG_BLOCK_SZ

_nitropy.NITF_CODE_20_SZ_swigconstant(_nitropy)
NITF_CODE_20_SZ = _nitropy.NITF_CODE_20_SZ

_nitropy.NITF_CTLH_20_SZ_swigconstant(_nitropy)
NITF_CTLH_20_SZ = _nitropy.NITF_CTLH_20_SZ

_nitropy.NITF_REL_20_SZ_swigconstant(_nitropy)
NITF_REL_20_SZ = _nitropy.NITF_REL_20_SZ

_nitropy.NITF_CAUT_20_SZ_swigconstant(_nitropy)
NITF_CAUT_20_SZ = _nitropy.NITF_CAUT_20_SZ

_nitropy.NITF_CTLN_20_SZ_swigconstant(_nitropy)
NITF_CTLN_20_SZ = _nitropy.NITF_CTLN_20_SZ

_nitropy.NITF_DGDT_20_SZ_swigconstant(_nitropy)
NITF_DGDT_20_SZ = _nitropy.NITF_DGDT_20_SZ

_nitropy.NITF_CLTX_20_SZ_swigconstant(_nitropy)
...
_nitropy.NITF_TRE_RAW_swigconstant(_nitropy)
NITF_TRE_RAW = _nitropy.NITF_TRE_RAW

_nitropy.NITF_MAX_TAG_swigconstant(_nitropy)
NITF_MAX_TAG = _nitropy.NITF_MAX_TAG

_nitropy.NITF_ETAG_SZ_swigconstant(_nitropy)
NITF_ETAG_SZ = _nitropy.NITF_ETAG_SZ

_nitropy.NITF_EL_SZ_swigconstant(_nitropy)
NITF_EL_SZ = _nitropy.NITF_EL_SZ

_nitropy.NITF_TRE_DEFAULT_LENGTH_swigconstant(_nitropy)
NITF_TRE_DEFAULT_LENGTH = _nitropy.NITF_TRE_DEFAULT_LENGTH

_nitropy.NITF_TRE_CONDITIONAL_LENGTH_swigconstant(_nitropy)
NITF_TRE_CONDITIONAL_LENGTH = _nitropy.NITF_TRE_CONDITIONAL_LENGTH

_nitropy.NITF_TRE_GOBBLE_swigconstant(_nitropy)
NITF_TRE_GOBBLE = _nitropy.NITF_TRE_GOBBLE

_nitropy.NITF_LOOP_swigconstant(_nitropy)
NITF_LOOP = _nitropy.NITF_LOOP

_nitropy.NITF_ENDLOOP_swigconstant(_nitropy)
NITF_ENDLOOP = _nitropy.NITF_ENDLOOP

_nitropy.NITF_IF_swigconstant(_nitropy)
NITF_IF = _nitropy.NITF_IF

_nitropy.NITF_ENDIF_swigconstant(_nitropy)
NITF_ENDIF = _nitropy.NITF_ENDIF

_nitropy.NITF_COMP_LEN_swigconstant(_nitropy)
NITF_COMP_LEN = _nitropy.NITF_COMP_LEN

_nitropy.NITF_END_swigconstant(_nitropy)
NITF_END = _nitropy.NITF_END

_nitropy.NITF_CONST_N_swigconstant(_nitropy)
NITF_CONST_N = _nitropy.NITF_CONST_N

_nitropy.NITF_FUNCTION_swigconstant(_nitropy)
...
_nitropy.NRT_DATA_RETAIN_OWNER_swigconstant(_nitropy)
NRT_DATA_RETAIN_OWNER = _nitropy.NRT_DATA_RETAIN_OWNER

_nitropy.NRT_DATA_ADOPT_swigconstant(_nitropy)
...
_nitropy.NITF_FHDR_SZ_swigconstant(_nitropy)
NITF_FHDR_SZ = _nitropy.NITF_FHDR_SZ

_nitropy.NITF_FVER_SZ_swigconstant(_nitropy)
NITF_FVER_SZ = _nitropy.NITF_FVER_SZ

_nitropy.NITF_CLEVEL_SZ_swigconstant(_nitropy)
NITF_CLEVEL_SZ = _nitropy.NITF_CLEVEL_SZ

_nitropy.NITF_STYPE_SZ_swigconstant(_nitropy)
NITF_STYPE_SZ = _nitropy.NITF_STYPE_SZ

_nitropy.NITF_OSTAID_SZ_swigconstant(_nitropy)
NITF_OSTAID_SZ = _nitropy.NITF_OSTAID_SZ

_nitropy.NITF_FDT_SZ_swigconstant(_nitropy)
NITF_FDT_SZ = _nitropy.NITF_FDT_SZ

_nitropy.NITF_FTITLE_SZ_swigconstant(_nitropy)
NITF_FTITLE_SZ = _nitropy.NITF_FTITLE_SZ

_nitropy.NITF_FSCLAS_SZ_swigconstant(_nitropy)
NITF_FSCLAS_SZ = _nitropy.NITF_FSCLAS_SZ

_nitropy.NITF_FSCOP_SZ_swigconstant(_nitropy)
NITF_FSCOP_SZ = _nitropy.NITF_FSCOP_SZ

_nitropy.NITF_FSCPYS_SZ_swigconstant(_nitropy)
NITF_FSCPYS_SZ = _nitropy.NITF_FSCPYS_SZ

_nitropy.NITF_ENCRYP_SZ_swigconstant(_nitropy)
NITF_ENCRYP_SZ = _nitropy.NITF_ENCRYP_SZ

_nitropy.NITF_FBKGC_SZ_swigconstant(_nitropy)
NITF_FBKGC_SZ = _nitropy.NITF_FBKGC_SZ

_nitropy.NITF_ONAME_SZ_swigconstant(_nitropy)
NITF_ONAME_SZ = _nitropy.NITF_ONAME_SZ

_nitropy.NITF_OPHONE_SZ_swigconstant(_nitropy)
NITF_OPHONE_SZ = _nitropy.NITF_OPHONE_SZ

_nitropy.NITF_FL_SZ_swigconstant(_nitropy)
NITF_FL_SZ = _nitropy.NITF_FL_SZ

_nitropy.NITF_HL_SZ_swigconstant(_nitropy)
NITF_HL_SZ = _nitropy.NITF_HL_SZ

_nitropy.NITF_LISH_SZ_swigconstant(_nitropy)
NITF_LISH_SZ = _nitropy.NITF_LISH_SZ

_nitropy.NITF_LI_SZ_swigconstant(_nitropy)
NITF_LI_SZ = _nitropy.NITF_LI_SZ

_nitropy.NITF_LSSH_SZ_swigconstant(_nitropy)
NITF_LSSH_SZ = _nitropy.NITF_LSSH_SZ

_nitropy.NITF_LS_SZ_swigconstant(_nitropy)
NITF_LS_SZ = _nitropy.NITF_LS_SZ

_nitropy.NITF_LLSH_SZ_swigconstant(_nitropy)
NITF_LLSH_SZ = _nitropy.NITF_LLSH_SZ

_nitropy.NITF_LL_SZ_swigconstant(_nitropy)
NITF_LL_SZ = _nitropy.NITF_LL_SZ

_nitropy.NITF_LTSH_SZ_swigconstant(_nitropy)
NITF_LTSH_SZ = _nitropy.NITF_LTSH_SZ

_nitropy.NITF_LT_SZ_swigconstant(_nitropy)
NITF_LT_SZ = _nitropy.NITF_LT_SZ

_nitropy.NITF_LDSH_SZ_swigconstant(_nitropy)
NITF_LDSH_SZ = _nitropy.NITF_LDSH_SZ

_nitropy.NITF_LD_SZ_swigconstant(_nitropy)
NITF_LD_SZ = _nitropy.NITF_LD_SZ

_nitropy.NITF_LRESH_SZ_swigconstant(_nitropy)
NITF_LRESH_SZ = _nitropy.NITF_LRESH_SZ

_nitropy.NITF_LRE_SZ_swigconstant(_nitropy)
NITF_LRE_SZ = _nitropy.NITF_LRE_SZ

_nitropy.NITF_UDHDL_SZ_swigconstant(_nitropy)
NITF_UDHDL_SZ = _nitropy.NITF_UDHDL_SZ

_nitropy.NITF_UDHOFL_SZ_swigconstant(_nitropy)
NITF_UDHOFL_SZ = _nitropy.NITF_UDHOFL_SZ

_nitropy.NITF_XHDL_SZ_swigconstant(_nitropy)
NITF_XHDL_SZ = _nitropy.NITF_XHDL_SZ

_nitropy.NITF_XHDLOFL_SZ_swigconstant(_nitropy)
NITF_XHDLOFL_SZ = _nitropy.NITF_XHDLOFL_SZ

_nitropy.NITF_NUMI_SZ_swigconstant(_nitropy)
NITF_NUMI_SZ = _nitropy.NITF_NUMI_SZ

_nitropy.NITF_NUMS_SZ_swigconstant(_nitropy)
NITF_NUMS_SZ = _nitropy.NITF_NUMS_SZ

_nitropy.NITF_NUMX_SZ_swigconstant(_nitropy)
NITF_NUMX_SZ = _nitropy.NITF_NUMX_SZ

_nitropy.NITF_NUMT_SZ_swigconstant(_nitropy)
NITF_NUMT_SZ = _nitropy.NITF_NUMT_SZ

_nitropy.NITF_NUMDES_SZ_swigconstant(_nitropy)
NITF_NUMDES_SZ = _nitropy.NITF_NUMDES_SZ

_nitropy.NITF_NUMRES_SZ_swigconstant(_nitropy)
...
_nitropy.NITF_IM_SZ_swigconstant(_nitropy)
NITF_IM_SZ = _nitropy.NITF_IM_SZ

_nitropy.NITF_IID1_SZ_swigconstant(_nitropy)
NITF_IID1_SZ = _nitropy.NITF_IID1_SZ

_nitropy.NITF_IDATIM_SZ_swigconstant(_nitropy)
NITF_IDATIM_SZ = _nitropy.NITF_IDATIM_SZ

_nitropy.NITF_TGTID_SZ_swigconstant(_nitropy)
NITF_TGTID_SZ = _nitropy.NITF_TGTID_SZ

_nitropy.NITF_IID2_SZ_swigconstant(_nitropy)
NITF_IID2_SZ = _nitropy.NITF_IID2_SZ

_nitropy.NITF_ISCLAS_SZ_swigconstant(_nitropy)
NITF_ISCLAS_SZ = _nitropy.NITF_ISCLAS_SZ

_nitropy.NITF_ISORCE_SZ_swigconstant(_nitropy)
NITF_ISORCE_SZ = _nitropy.NITF_ISORCE_SZ

_nitropy.NITF_NROWS_SZ_swigconstant(_nitropy)
NITF_NROWS_SZ = _nitropy.NITF_NROWS_SZ

_nitropy.NITF_NCOLS_SZ_swigconstant(_nitropy)
NITF_NCOLS_SZ = _nitropy.NITF_NCOLS_SZ

_nitropy.NITF_PVTYPE_SZ_swigconstant(_nitropy)
NITF_PVTYPE_SZ = _nitropy.NITF_PVTYPE_SZ

_nitropy.NITF_IREP_SZ_swigconstant(_nitropy)
NITF_IREP_SZ = _nitropy.NITF_IREP_SZ

_nitropy.NITF_ICAT_SZ_swigconstant(_nitropy)
NITF_ICAT_SZ = _nitropy.NITF_ICAT_SZ

_nitropy.NITF_ABPP_SZ_swigconstant(_nitropy)
NITF_ABPP_SZ = _nitropy.NITF_ABPP_SZ

_nitropy.NITF_PJUST_SZ_swigconstant(_nitropy)
NITF_PJUST_SZ = _nitropy.NITF_PJUST_SZ

_nitropy.NITF_ICORDS_SZ_swigconstant(_nitropy)
NITF_ICORDS_SZ = _nitropy.NITF_ICORDS_SZ

_nitropy.NITF_IGEOLO_SZ_swigconstant(_nitropy)
NITF_IGEOLO_SZ = _nitropy.NITF_IGEOLO_SZ

_nitropy.NITF_NICOM_SZ_swigconstant(_nitropy)
NITF_NICOM_SZ = _nitropy.NITF_NICOM_SZ

_nitropy.NITF_ICOM_SZ_swigconstant(_nitropy)
NITF_ICOM_SZ = _nitropy.NITF_ICOM_SZ

_nitropy.NITF_IC_SZ_swigconstant(_nitropy)
NITF_IC_SZ = _nitropy.NITF_IC_SZ

_nitropy.NITF_COMRAT_SZ_swigconstant(_nitropy)
NITF_COMRAT_SZ = _nitropy.NITF_COMRAT_SZ

_nitropy.NITF_NBANDS_SZ_swigconstant(_nitropy)
NITF_NBANDS_SZ = _nitropy.NITF_NBANDS_SZ

_nitropy.NITF_XBANDS_SZ_swigconstant(_nitropy)
NITF_XBANDS_SZ = _nitropy.NITF_XBANDS_SZ

_nitropy.NITF_ISYNC_SZ_swigconstant(_nitropy)
NITF_ISYNC_SZ = _nitropy.NITF_ISYNC_SZ

_nitropy.NITF_IMODE_SZ_swigconstant(_nitropy)
NITF_IMODE_SZ = _nitropy.NITF_IMODE_SZ

_nitropy.NITF_NBPR_SZ_swigconstant(_nitropy)
NITF_NBPR_SZ = _nitropy.NITF_NBPR_SZ

_nitropy.NITF_NBPC_SZ_swigconstant(_nitropy)
NITF_NBPC_SZ = _nitropy.NITF_NBPC_SZ

_nitropy.NITF_NPPBH_SZ_swigconstant(_nitropy)
NITF_NPPBH_SZ = _nitropy.NITF_NPPBH_SZ

_nitropy.NITF_NPPBV_SZ_swigconstant(_nitropy)
NITF_NPPBV_SZ = _nitropy.NITF_NPPBV_SZ

_nitropy.NITF_NBPP_SZ_swigconstant(_nitropy)
NITF_NBPP_SZ = _nitropy.NITF_NBPP_SZ

_nitropy.NITF_IDLVL_SZ_swigconstant(_nitropy)
NITF_IDLVL_SZ = _nitropy.NITF_IDLVL_SZ

_nitropy.NITF_IALVL_SZ_swigconstant(_nitropy)
NITF_IALVL_SZ = _nitropy.NITF_IALVL_SZ

_nitropy.NITF_ILOC_SZ_swigconstant(_nitropy)
NITF_ILOC_SZ = _nitropy.NITF_ILOC_SZ

_nitropy.NITF_IMAG_SZ_swigconstant(_nitropy)
NITF_IMAG_SZ = _nitropy.NITF_IMAG_SZ

_nitropy.NITF_UDIDL_SZ_swigconstant(_nitropy)
NITF_UDIDL_SZ = _nitropy.NITF_UDIDL_SZ

_nitropy.NITF_UDOFL_SZ_swigconstant(_nitropy)
NITF_UDOFL_SZ = _nitropy.NITF_UDOFL_SZ

_nitropy.NITF_IXSHDL_SZ_swigconstant(_nitropy)
NITF_IXSHDL_SZ = _nitropy.NITF_IXSHDL_SZ

_nitropy.NITF_IXSOFL_SZ_swigconstant(_nitropy)
NITF_IXSOFL_SZ = _nitropy.NITF_IXSOFL_SZ

_nitropy.NITF_MAX_BAND_COUNT_swigconstant(_nitropy)
...
_nitropy.NITF_SY_SZ_swigconstant(_nitropy)
NITF_SY_SZ = _nitropy.NITF_SY_SZ

_nitropy.NITF_SID_SZ_swigconstant(_nitropy)
NITF_SID_SZ = _nitropy.NITF_SID_SZ

_nitropy.NITF_SNAME_SZ_swigconstant(_nitropy)
NITF_SNAME_SZ = _nitropy.NITF_SNAME_SZ

_nitropy.NITF_SSCLAS_SZ_swigconstant(_nitropy)
NITF_SSCLAS_SZ = _nitropy.NITF_SSCLAS_SZ

_nitropy.NITF_SFMT_SZ_swigconstant(_nitropy)
NITF_SFMT_SZ = _nitropy.NITF_SFMT_SZ

_nitropy.NITF_SSTRUCT_SZ_swigconstant(_nitropy)
NITF_SSTRUCT_SZ = _nitropy.NITF_SSTRUCT_SZ

_nitropy.NITF_SDLVL_SZ_swigconstant(_nitropy)
NITF_SDLVL_SZ = _nitropy.NITF_SDLVL_SZ

_nitropy.NITF_SALVL_SZ_swigconstant(_nitropy)
NITF_SALVL_SZ = _nitropy.NITF_SALVL_SZ

_nitropy.NITF_SLOC_SZ_swigconstant(_nitropy)
NITF_SLOC_SZ = _nitropy.NITF_SLOC_SZ

_nitropy.NITF_SBND1_SZ_swigconstant(_nitropy)
NITF_SBND1_SZ = _nitropy.NITF_SBND1_SZ

_nitropy.NITF_SCOLOR_SZ_swigconstant(_nitropy)
NITF_SCOLOR_SZ = _nitropy.NITF_SCOLOR_SZ

_nitropy.NITF_SBND2_SZ_swigconstant(_nitropy)
NITF_SBND2_SZ = _nitropy.NITF_SBND2_SZ

_nitropy.NITF_SRES2_SZ_swigconstant(_nitropy)
NITF_SRES2_SZ = _nitropy.NITF_SRES2_SZ

_nitropy.NITF_SXSHDL_SZ_swigconstant(_nitropy)
NITF_SXSHDL_SZ = _nitropy.NITF_SXSHDL_SZ

_nitropy.NITF_SXSOFL_SZ_swigconstant(_nitropy)
...
_nitropy.NITF_LA_SZ_swigconstant(_nitropy)
NITF_LA_SZ = _nitropy.NITF_LA_SZ

_nitropy.NITF_LID_SZ_swigconstant(_nitropy)
NITF_LID_SZ = _nitropy.NITF_LID_SZ

_nitropy.NITF_LSCLAS_SZ_swigconstant(_nitropy)
NITF_LSCLAS_SZ = _nitropy.NITF_LSCLAS_SZ

_nitropy.NITF_LFS_SZ_swigconstant(_nitropy)
NITF_LFS_SZ = _nitropy.NITF_LFS_SZ

_nitropy.NITF_LCW_SZ_swigconstant(_nitropy)
NITF_LCW_SZ = _nitropy.NITF_LCW_SZ

_nitropy.NITF_LCH_SZ_swigconstant(_nitropy)
NITF_LCH_SZ = _nitropy.NITF_LCH_SZ

_nitropy.NITF_LDLVL_SZ_swigconstant(_nitropy)
NITF_LDLVL_SZ = _nitropy.NITF_LDLVL_SZ

_nitropy.NITF_LALVL_SZ_swigconstant(_nitropy)
NITF_LALVL_SZ = _nitropy.NITF_LALVL_SZ

_nitropy.NITF_LLOCR_SZ_swigconstant(_nitropy)
NITF_LLOCR_SZ = _nitropy.NITF_LLOCR_SZ

_nitropy.NITF_LLOCC_SZ_swigconstant(_nitropy)
NITF_LLOCC_SZ = _nitropy.NITF_LLOCC_SZ

_nitropy.NITF_LTC_SZ_swigconstant(_nitropy)
NITF_LTC_SZ = _nitropy.NITF_LTC_SZ

_nitropy.NITF_LBC_SZ_swigconstant(_nitropy)
NITF_LBC_SZ = _nitropy.NITF_LBC_SZ

_nitropy.NITF_LXSHDL_SZ_swigconstant(_nitropy)
NITF_LXSHDL_SZ = _nitropy.NITF_LXSHDL_SZ

_nitropy.NITF_LXSOFL_SZ_swigconstant(_nitropy)
...
_nitropy.NITF_TE_SZ_swigconstant(_nitropy)
NITF_TE_SZ = _nitropy.NITF_TE_SZ

_nitropy.NITF_TEXTID_SZ_swigconstant(_nitropy)
NITF_TEXTID_SZ = _nitropy.NITF_TEXTID_SZ

_nitropy.NITF_TXTALVL_SZ_swigconstant(_nitropy)
NITF_TXTALVL_SZ = _nitropy.NITF_TXTALVL_SZ

_nitropy.NITF_TXTDT_SZ_swigconstant(_nitropy)
NITF_TXTDT_SZ = _nitropy.NITF_TXTDT_SZ

_nitropy.NITF_TXTITL_SZ_swigconstant(_nitropy)
NITF_TXTITL_SZ = _nitropy.NITF_TXTITL_SZ

_nitropy.NITF_TSCLAS_SZ_swigconstant(_nitropy)
NITF_TSCLAS_SZ = _nitropy.NITF_TSCLAS_SZ

_nitropy.NITF_TXTFMT_SZ_swigconstant(_nitropy)
NITF_TXTFMT_SZ = _nitropy.NITF_TXTFMT_SZ

_nitropy.NITF_TXSHDL_SZ_swigconstant(_nitropy)
NITF_TXSHDL_SZ = _nitropy.NITF_TXSHDL_SZ

_nitropy.NITF_TXSOFL_SZ_swigconstant(_nitropy)
...
_nitropy.NITF_DE_SZ_swigconstant(_nitropy)
NITF_DE_SZ = _nitropy.NITF_DE_SZ

_nitropy.NITF_DESTAG_SZ_swigconstant(_nitropy)
NITF_DESTAG_SZ = _nitropy.NITF_DESTAG_SZ

_nitropy.NITF_DESVER_SZ_swigconstant(_nitropy)
NITF_DESVER_SZ = _nitropy.NITF_DESVER_SZ

_nitropy.NITF_DESCLAS_SZ_swigconstant(_nitropy)
NITF_DESCLAS_SZ = _nitropy.NITF_DESCLAS_SZ

_nitropy.NITF_DESOFLW_SZ_swigconstant(_nitropy)
NITF_DESOFLW_SZ = _nitropy.NITF_DESOFLW_SZ

_nitropy.NITF_DESITEM_SZ_swigconstant(_nitropy)
NITF_DESITEM_SZ = _nitropy.NITF_DESITEM_SZ

_nitropy.NITF_DESSHL_SZ_swigconstant(_nitropy)
...
_nitropy.NITF_RE_SZ_swigconstant(_nitropy)
NITF_RE_SZ = _nitropy.NITF_RE_SZ

_nitropy.NITF_RESTAG_SZ_swigconstant(_nitropy)
NITF_RESTAG_SZ = _nitropy.NITF_RESTAG_SZ

_nitropy.NITF_RESVER_SZ_swigconstant(_nitropy)
NITF_RESVER_SZ = _nitropy.NITF_RESVER_SZ

_nitropy.NITF_RESCLAS_SZ_swigconstant(_nitropy)
NITF_RESCLAS_SZ = _nitropy.NITF_RESCLAS_SZ

_nitropy.NITF_RESSHL_SZ_swigconstant(_nitropy)
...
_nitropy.NITF_IREPBAND_SZ_swigconstant(_nitropy)
NITF_IREPBAND_SZ = _nitropy.NITF_IREPBAND_SZ

_nitropy.NITF_ISUBCAT_SZ_swigconstant(_nitropy)
NITF_ISUBCAT_SZ = _nitropy.NITF_ISUBCAT_SZ

_nitropy.NITF_IFC_SZ_swigconstant(_nitropy)
NITF_IFC_SZ = _nitropy.NITF_IFC_SZ

_nitropy.NITF_IMFLT_SZ_swigconstant(_nitropy)
NITF_IMFLT_SZ = _nitropy.NITF_IMFLT_SZ

_nitropy.NITF_NLUTS_SZ_swigconstant(_nitropy)
NITF_NLUTS_SZ = _nitropy.NITF_NLUTS_SZ

_nitropy.NITF_NELUT_SZ_swigconstant(_nitropy)
...
_nitropy.PY_NITF_CREATE_swigconstant(_nitropy)
PY_NITF_CREATE = _nitropy.PY_NITF_CREATE

_nitropy.PY_NITF_TRUNCATE_swigconstant(_nitropy)
PY_NITF_TRUNCATE = _nitropy.PY_NITF_TRUNCATE

_nitropy.PY_NITF_OPEN_EXISTING_swigconstant(_nitropy)
PY_NITF_OPEN_EXISTING = _nitropy.PY_NITF_OPEN_EXISTING

_nitropy.PY_NITF_ACCESS_READONLY_swigconstant(_nitropy)
PY_NITF_ACCESS_READONLY = _nitropy.PY_NITF_ACCESS_READONLY

_nitropy.PY_NITF_ACCESS_WRITEONLY_swigconstant(_nitropy)
PY_NITF_ACCESS_WRITEONLY = _nitropy.PY_NITF_ACCESS_WRITEONLY

_nitropy.PY_NITF_ACCESS_READWRITE_swigconstant(_nitropy)
PY_NITF_ACCESS_READWRITE = _nitropy.PY_NITF_ACCESS_READWRITE

_nitropy.PY_NITF_SEEK_CUR_swigconstant(_nitropy)
PY_NITF_SEEK_CUR = _nitropy.PY_NITF_SEEK_CUR

_nitropy.PY_NITF_SEEK_SET_swigconstant(_nitropy)
PY_NITF_SEEK_SET = _nitropy.PY_NITF_SEEK_SET

_nitropy.PY_NITF_SEEK_END_swigconstant(_nitropy)
