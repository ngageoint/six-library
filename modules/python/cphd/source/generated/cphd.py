...
class RowColDouble(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["row"] = _cphd.RowColDouble_row_set
    __swig_getmethods__["row"] = _cphd.RowColDouble_row_get
    if _newclass:
        row = _swig_property(_cphd.RowColDouble_row_get, _cphd.RowColDouble_row_set)
    __swig_setmethods__["col"] = _cphd.RowColDouble_col_set
    __swig_getmethods__["col"] = _cphd.RowColDouble_col_get
    if _newclass:
        col = _swig_property(_cphd.RowColDouble_col_get, _cphd.RowColDouble_col_set)
    ...
    def __init__(self, *args):
        ...
        """
        this = _cphd.new_RowColDouble(*args)
        try:
    ...
    __swig_destroy__ = _cphd.delete_RowColDouble
    __del__ = lambda self: None
RowColDouble_swigregister = _cphd.RowColDouble_swigregister
...
class RowColSizeT(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["row"] = _cphd.RowColSizeT_row_set
    __swig_getmethods__["row"] = _cphd.RowColSizeT_row_get
    if _newclass:
        row = _swig_property(_cphd.RowColSizeT_row_get, _cphd.RowColSizeT_row_set)
    __swig_setmethods__["col"] = _cphd.RowColSizeT_col_set
    __swig_getmethods__["col"] = _cphd.RowColSizeT_col_get
    if _newclass:
        col = _swig_property(_cphd.RowColSizeT_col_get, _cphd.RowColSizeT_col_set)
    ...
    def __init__(self, *args):
        ...
        """
        this = _cphd.new_RowColSizeT(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def normL2(self):
        ...
        return _cphd.RowColSizeT_normL2(self)

    __swig_destroy__ = _cphd.delete_RowColSizeT
    __del__ = lambda self: None
RowColSizeT_swigregister = _cphd.RowColSizeT_swigregister
...
class RgAzDouble(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["rg"] = _cphd.RgAzDouble_rg_set
    __swig_getmethods__["rg"] = _cphd.RgAzDouble_rg_get
    if _newclass:
        rg = _swig_property(_cphd.RgAzDouble_rg_get, _cphd.RgAzDouble_rg_set)
    __swig_setmethods__["az"] = _cphd.RgAzDouble_az_set
    __swig_getmethods__["az"] = _cphd.RgAzDouble_az_get
    if _newclass:
        az = _swig_property(_cphd.RgAzDouble_az_get, _cphd.RgAzDouble_az_set)
    ...
    def __init__(self, *args):
        ...
        """
        this = _cphd.new_RgAzDouble(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def __iadd__(self, scalar):
        ...
        return _cphd.RgAzDouble___iadd__(self, scalar)


    def __add__(self, scalar):
        """__add__(RgAzDouble self, double scalar) -> RgAzDouble"""
        return _cphd.RgAzDouble___add__(self, scalar)


    def __isub__(self, scalar):
        """__isub__(RgAzDouble self, double scalar) -> RgAzDouble"""
        return _cphd.RgAzDouble___isub__(self, scalar)


    def __sub__(self, scalar):
        """__sub__(RgAzDouble self, double scalar) -> RgAzDouble"""
        return _cphd.RgAzDouble___sub__(self, scalar)


    def __imul__(self, scalar):
        """__imul__(RgAzDouble self, double scalar) -> RgAzDouble"""
        return _cphd.RgAzDouble___imul__(self, scalar)


    def __mul__(self, scalar):
        """__mul__(RgAzDouble self, double scalar) -> RgAzDouble"""
        return _cphd.RgAzDouble___mul__(self, scalar)


    def __idiv__(self, scalar):
        """__idiv__(RgAzDouble self, double scalar) -> RgAzDouble"""
        return _cphd.RgAzDouble___idiv__(self, scalar)


    def __div__(self, scalar):
        """__div__(RgAzDouble self, double scalar) -> RgAzDouble"""
        return _cphd.RgAzDouble___div__(self, scalar)


    def __eq__(self, p):
        """__eq__(RgAzDouble self, RgAzDouble p) -> bool"""
        return _cphd.RgAzDouble___eq__(self, p)


    def __ne__(self, p):
        """__ne__(RgAzDouble self, RgAzDouble p) -> bool"""
        return _cphd.RgAzDouble___ne__(self, p)

    __swig_destroy__ = _cphd.delete_RgAzDouble
    __del__ = lambda self: None
RgAzDouble_swigregister = _cphd.RgAzDouble_swigregister
...
class FileHeader(_object):
    ...
    def isCPHD(inStream):
        """isCPHD(io::SeekableInputStream & inStream) -> bool"""
        return _cphd.FileHeader_isCPHD(inStream)

    if _newclass:
        isCPHD = staticmethod(isCPHD)
    __swig_getmethods__["isCPHD"] = lambda x: isCPHD

    def readVersion(inStream):
        """readVersion(io::SeekableInputStream & inStream) -> std::string"""
        return _cphd.FileHeader_readVersion(inStream)

    if _newclass:
        readVersion = staticmethod(readVersion)
    __swig_getmethods__["readVersion"] = lambda x: readVersion

    def read(self, inStream):
        """read(FileHeader self, io::SeekableInputStream & inStream)"""
...
def FileHeader_isCPHD(inStream):
    """FileHeader_isCPHD(io::SeekableInputStream & inStream) -> bool"""
    return _cphd.FileHeader_isCPHD(inStream)

def FileHeader_readVersion(inStream):
    """FileHeader_readVersion(io::SeekableInputStream & inStream) -> std::string"""
    return _cphd.FileHeader_readVersion(inStream)
...
class Antenna(_object):
    ...
    def __init__(self):
        """__init__(cphd::Antenna self) -> Antenna"""
        this = _cphd.new_Antenna()
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def __eq__(self, other):
        """__eq__(Antenna self, Antenna other) -> bool"""
        return _cphd.Antenna___eq__(self, other)


    def __ne__(self, other):
        """__ne__(Antenna self, Antenna other) -> bool"""
        return _cphd.Antenna___ne__(self, other)

    __swig_setmethods__["numTxAnt"] = _cphd.Antenna_numTxAnt_set
    __swig_getmethods__["numTxAnt"] = _cphd.Antenna_numTxAnt_get
    if _newclass:
        numTxAnt = _swig_property(_cphd.Antenna_numTxAnt_get, _cphd.Antenna_numTxAnt_set)
    __swig_setmethods__["numRcvAnt"] = _cphd.Antenna_numRcvAnt_set
    __swig_getmethods__["numRcvAnt"] = _cphd.Antenna_numRcvAnt_get
    if _newclass:
        numRcvAnt = _swig_property(_cphd.Antenna_numRcvAnt_get, _cphd.Antenna_numRcvAnt_set)
    __swig_setmethods__["numTWAnt"] = _cphd.Antenna_numTWAnt_set
    __swig_getmethods__["numTWAnt"] = _cphd.Antenna_numTWAnt_get
    if _newclass:
        numTWAnt = _swig_property(_cphd.Antenna_numTWAnt_get, _cphd.Antenna_numTWAnt_set)
    __swig_setmethods__["tx"] = _cphd.Antenna_tx_set
    __swig_getmethods__["tx"] = _cphd.Antenna_tx_get
    if _newclass:
        tx = _swig_property(_cphd.Antenna_tx_get, _cphd.Antenna_tx_set)
    __swig_setmethods__["rcv"] = _cphd.Antenna_rcv_set
    __swig_getmethods__["rcv"] = _cphd.Antenna_rcv_get
    if _newclass:
        rcv = _swig_property(_cphd.Antenna_rcv_get, _cphd.Antenna_rcv_set)
    __swig_setmethods__["twoWay"] = _cphd.Antenna_twoWay_set
    __swig_getmethods__["twoWay"] = _cphd.Antenna_twoWay_get
    if _newclass:
        twoWay = _swig_property(_cphd.Antenna_twoWay_get, _cphd.Antenna_twoWay_set)
    __swig_destroy__ = _cphd.delete_Antenna
    __del__ = lambda self: None
Antenna_swigregister = _cphd.Antenna_swigregister
...
class VBM(_object):
    ...
    def getTxPos(self, channel, vector):
        """getTxPos(VBM self, size_t channel, size_t vector) -> cphd::Vector3"""
    ...
    def getRcvPos(self, channel, vector):
        """getRcvPos(VBM self, size_t channel, size_t vector) -> cphd::Vector3"""
    ...
    def getSRPPos(self, channel, vector):
        """getSRPPos(VBM self, size_t channel, size_t vector) -> cphd::Vector3"""
    ...
    def setTxPos(self, value, channel, vector):
        """setTxPos(VBM self, cphd::Vector3 const & value, size_t channel, size_t vector)"""
    ...
    def setRcvPos(self, value, channel, vector):
        """setRcvPos(VBM self, cphd::Vector3 const & value, size_t channel, size_t vector)"""
    ...
    def setSRPPos(self, value, channel, vector):
        """setSRPPos(VBM self, cphd::Vector3 const & value, size_t channel, size_t vector)"""
    ...
    def load(self, inStream, startVBM, sizeVBM, numThreads):
        """load(VBM self, io::SeekableInputStream & inStream, sys::Off_T startVBM, sys::Off_T sizeVBM, size_t numThreads) -> sys::Off_T"""
...
class Wideband(_object):
    ...
    def read(self, *args):
        ...
        read(Wideband self, size_t channel, size_t firstVector, size_t lastVector, size_t firstSample, size_t lastSample, std::vector< double,std::allocator< double > > const & vectorScaleFactors, size_t numThreads, mem::BufferView< sys::ubyte > const & scratch, mem::BufferView< std::complex< float > > const & data)
    ...
    def readImpl(self, channel, firstVector, lastVector, firstSample, lastSample, numThreads, dims, data):
        """readImpl(Wideband self, size_t channel, size_t firstVector, size_t lastVector, size_t firstSample, size_t lastSample, size_t numThreads, RowColSizeT dims, size_t data)"""
