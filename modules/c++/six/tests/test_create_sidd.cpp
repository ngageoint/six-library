 ...
 *
 */
six::ComplexData* getComplexData(std::string sicdXMLName)
{
    ...
    six::ComplexXMLControl xmlControl;
    return (six::ComplexData*) xmlControl.fromXML(doc);
}
...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        for (unsigned int i = 0; i < repeatN; ++i)
        {
            ...
            // Make the object
            six::DerivedDataBuilder builder;
            six::DerivedData* data = builder.steal(); //steal it
            ...
            six::ProcessorInformation* processorInformation =
            ...
            six::PlaneProjection* planeProjection =
                    (six::PlaneProjection*) data->measurement->projection;
