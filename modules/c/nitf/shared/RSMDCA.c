...
static nitf_TREDescription RSMDCA_description[] = {
    ...
    {NITF_BCS_N, 3, "Number of Images", "NIMGE" },

    {NITF_BCS_N, 5, "Total Number of Parameters", "NPART" },

    {NITF_LOOP, 0, NULL, "NIMGE"},

    {NITF_BCS_A, 80, "Image Identifier", "IIDI" },
    {NITF_BCS_N, 2, "Number of Parameters", "NPARI" },
    ...
    {NITF_LOOP, 0, NITF_FUNCTION, (char*)&count},

    {NITF_BCS_A, 21, "Direct Error Covariance Element", "DERCOV" },
...
NITF_DECLARE_SINGLE_PLUGIN_SIMPLE(RSMDCA)
