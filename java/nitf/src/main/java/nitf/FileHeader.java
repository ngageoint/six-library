 ...
 * <p/>
 * In NITF, the file header is the first section of a file (before
 * the image subheaders).  It gives the reader information about
 * the length of the file, and how many components to expect.  It
 * also contains security info and TRE extensions
 */
public final class FileHeader extends NITFObject
{
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getClassification();

    /**
     * Retrieve the NITF compliance level of the writer
     * that wrote this file.
     *
     * @return A Field corresponding to the field
     */
    public native synchronized Field getComplianceLevel();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getFileDateTime();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getFileHeader();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getFileLength();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getFileTitle();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getFileVersion();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getHeaderLength();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getMessageCopyNum();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getMessageNumCopies();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getNumDataExtensions();


    /**
     * Get the number of graphics segments in the file.
     * Only matters in a 2.1 file
     *
     * @return A Field corresponding to the field
     */
    public native synchronized Field getNumGraphics();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getNumImages();


    /**
     * Get the number of label segments in the file.
     * Only matters in a 2.0 file
     *
     * @return A Field corresponding to the field
     */
    public native synchronized Field getNumLabels();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getNumReservedExtensions();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getNumTexts();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getOriginatorName();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getOriginatorPhone();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getOriginStationID();

    /**
     * Get back a representation of the file security block
     * of the header
     *
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getSystemType();
     ...
     * @return A Field corresponding to the field
     */
    public native synchronized Field getUserDefinedHeaderLength();
     ...
     */
    public native synchronized ComponentInfo[] getImageInfo()
            throws NITFException;


    /**
     * Info related to the graphic info (length, etc).
     * This only matters for NITF 2.1
     *
     * @return The corresponding info object array (1 for each)
     */
    public native synchronized ComponentInfo[] getGraphicInfo()
            throws NITFException;


    /**
     * Info related to the label info (length, etc).
     * This only matters for NITF 2.0
     *
     * @return The corresponding info object array (1 for each)
     */
    public native synchronized ComponentInfo[] getLabelInfo()
            throws NITFException;
     ...
     * @return The corresponding info object array (1 for each)
     */
    public native synchronized ComponentInfo[] getTextInfo()
            throws NITFException;
     ...
     * @return The corresponding info object array (1 for each)
     */
    public native synchronized ComponentInfo[] getDataExtensionInfo()
            throws NITFException;
     ...
     * @return The corresponding info object array (1 for each)
     */
    public native synchronized ComponentInfo[] getReservedExtensionInfo()
            throws NITFException;
    ...
    public void print(PrintStream out) throws NITFException
    {
        ...
        out.println(
                "NumReservedExtensions = [" + getNumReservedExtensions() + "]");
        try
        {
