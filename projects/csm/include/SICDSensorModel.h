 ...
 *
 * @brief This class implements the TSMSensorModel API for SICD data
 *
...
public:
     ...
     */
    SICDSensorModel(const std::string& filename,
     ...
     * \param sensorModel   the name/id of this sensor model
     */
    SICDSensorModel(NITF_2_1_ISD* imageSupportData,
                    const std::string& sensorModel);
