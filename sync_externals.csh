...
git remote add -m 2023/main -f coda-oss_remote git@github.com:mdaus/coda-oss.git
git remote add -m 3.0/main -f nitro_remote git@github.com:mdaus/nitro.git
...
# git subtree add --prefix externals/coda-oss coda-oss_remote cpp17 --squash

# Same deal for NITRO
# git subtree add --prefix externals/nitro nitro_remote cpp17 --squash
...
git subtree pull --prefix externals/coda-oss coda-oss_remote 2023/main --squash

git subtree pull --prefix externals/nitro nitro_remote 3.0/main --squash
