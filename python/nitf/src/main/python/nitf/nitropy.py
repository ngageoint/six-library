...
class nitf_Error(_object):
    ...
    def __init__(self, *args): 
        this = _nitropy.new_nitf_Error(*args)
...
NITF_DES_HASH_SIZE = _nitropy.NITF_DES_HASH_SIZE
NITF_PLUGIN_PATH = _nitropy.NITF_PLUGIN_PATH
NITF_DEFAULT_PLUGIN_PATH = _nitropy.NITF_DEFAULT_PLUGIN_PATH
class nitf_PluginRegistry(_object):
    ...
    __swig_setmethods__["desHandlers"] = _nitropy.nitf_PluginRegistry_desHandlers_set
    __swig_getmethods__["desHandlers"] = _nitropy.nitf_PluginRegistry_desHandlers_get
    if _newclass:desHandlers = _swig_property(_nitropy.nitf_PluginRegistry_desHandlers_get, _nitropy.nitf_PluginRegistry_desHandlers_set)
...
nitf_PluginRegistry_retrieveTREDescription = _nitropy.nitf_PluginRegistry_retrieveTREDescription
nitf_PluginRegistry_retrieveSetTREDescription = _nitropy.nitf_PluginRegistry_retrieveSetTREDescription
nitf_PluginRegistry_retrieveDecompConstructor = _nitropy.nitf_PluginRegistry_retrieveDecompConstructor
nitf_PluginRegistry_retrieveDESConstructor = _nitropy.nitf_PluginRegistry_retrieveDESConstructor
class nitf_Reader(_object):
    ...
    __swig_setmethods__["inputHandle"] = _nitropy.nitf_Reader_inputHandle_set
    __swig_getmethods__["inputHandle"] = _nitropy.nitf_Reader_inputHandle_get
    if _newclass:inputHandle = _swig_property(_nitropy.nitf_Reader_inputHandle_get, _nitropy.nitf_Reader_inputHandle_set)
...
class nitf_Writer(_object):
    ...
    __swig_setmethods__["outputHandle"] = _nitropy.nitf_Writer_outputHandle_set
    __swig_getmethods__["outputHandle"] = _nitropy.nitf_Writer_outputHandle_get
    if _newclass:outputHandle = _swig_property(_nitropy.nitf_Writer_outputHandle_get, _nitropy.nitf_Writer_outputHandle_set)
...
class nitf_Record(_object):
    ...
    __swig_setmethods__["parseInfo"] = _nitropy.nitf_Record_parseInfo_set
    __swig_getmethods__["parseInfo"] = _nitropy.nitf_Record_parseInfo_get
    if _newclass:parseInfo = _swig_property(_nitropy.nitf_Record_parseInfo_get, _nitropy.nitf_Record_parseInfo_set)
...
NITF_NO_RANGE = _nitropy.NITF_NO_RANGE
NITF_U32_RANGE = _nitropy.NITF_U32_RANGE
NITF_S32_RANGE = _nitropy.NITF_S32_RANGE
NITF_U64_RANGE = _nitropy.NITF_U64_RANGE
NITF_S64_RANGE = _nitropy.NITF_S64_RANGE
NITF_CONST_N = _nitropy.NITF_CONST_N
class nitf_TREDescription(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, nitf_TREDescription, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, nitf_TREDescription, name)
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    __swig_setmethods__["data_type"] = _nitropy.nitf_TREDescription_data_type_set
    __swig_getmethods__["data_type"] = _nitropy.nitf_TREDescription_data_type_get
    if _newclass:data_type = _swig_property(_nitropy.nitf_TREDescription_data_type_get, _nitropy.nitf_TREDescription_data_type_set)
    __swig_setmethods__["data_count"] = _nitropy.nitf_TREDescription_data_count_set
    __swig_getmethods__["data_count"] = _nitropy.nitf_TREDescription_data_count_get
    if _newclass:data_count = _swig_property(_nitropy.nitf_TREDescription_data_count_get, _nitropy.nitf_TREDescription_data_count_set)
    __swig_setmethods__["label"] = _nitropy.nitf_TREDescription_label_set
    __swig_getmethods__["label"] = _nitropy.nitf_TREDescription_label_get
    if _newclass:label = _swig_property(_nitropy.nitf_TREDescription_label_get, _nitropy.nitf_TREDescription_label_set)
    __swig_setmethods__["tag"] = _nitropy.nitf_TREDescription_tag_set
    __swig_getmethods__["tag"] = _nitropy.nitf_TREDescription_tag_get
    if _newclass:tag = _swig_property(_nitropy.nitf_TREDescription_tag_get, _nitropy.nitf_TREDescription_tag_set)
    __swig_setmethods__["pattern"] = _nitropy.nitf_TREDescription_pattern_set
    __swig_getmethods__["pattern"] = _nitropy.nitf_TREDescription_pattern_get
    if _newclass:pattern = _swig_property(_nitropy.nitf_TREDescription_pattern_get, _nitropy.nitf_TREDescription_pattern_set)
    __swig_setmethods__["rangeCategory"] = _nitropy.nitf_TREDescription_rangeCategory_set
    __swig_getmethods__["rangeCategory"] = _nitropy.nitf_TREDescription_rangeCategory_get
    if _newclass:rangeCategory = _swig_property(_nitropy.nitf_TREDescription_rangeCategory_get, _nitropy.nitf_TREDescription_rangeCategory_set)
    __swig_setmethods__["minValue"] = _nitropy.nitf_TREDescription_minValue_set
    __swig_getmethods__["minValue"] = _nitropy.nitf_TREDescription_minValue_get
    if _newclass:minValue = _swig_property(_nitropy.nitf_TREDescription_minValue_get, _nitropy.nitf_TREDescription_minValue_set)
    __swig_setmethods__["maxValue"] = _nitropy.nitf_TREDescription_maxValue_set
    __swig_getmethods__["maxValue"] = _nitropy.nitf_TREDescription_maxValue_get
    if _newclass:maxValue = _swig_property(_nitropy.nitf_TREDescription_maxValue_get, _nitropy.nitf_TREDescription_maxValue_set)
    __swig_destroy__ = _nitropy.delete_nitf_TREDescription
    __del__ = lambda self : None;
nitf_TREDescription_swigregister = _nitropy.nitf_TREDescription_swigregister
nitf_TREDescription_swigregister(nitf_TREDescription)

NITF_TRE_DESC_NO_LENGTH = _nitropy.NITF_TRE_DESC_NO_LENGTH
class nitf_TREDescriptionInfo(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, nitf_TREDescriptionInfo, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, nitf_TREDescriptionInfo, name)
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    __swig_setmethods__["name"] = _nitropy.nitf_TREDescriptionInfo_name_set
    __swig_getmethods__["name"] = _nitropy.nitf_TREDescriptionInfo_name_get
    if _newclass:name = _swig_property(_nitropy.nitf_TREDescriptionInfo_name_get, _nitropy.nitf_TREDescriptionInfo_name_set)
    __swig_setmethods__["description"] = _nitropy.nitf_TREDescriptionInfo_description_set
    __swig_getmethods__["description"] = _nitropy.nitf_TREDescriptionInfo_description_get
    if _newclass:description = _swig_property(_nitropy.nitf_TREDescriptionInfo_description_get, _nitropy.nitf_TREDescriptionInfo_description_set)
    __swig_setmethods__["lengthMatch"] = _nitropy.nitf_TREDescriptionInfo_lengthMatch_set
    __swig_getmethods__["lengthMatch"] = _nitropy.nitf_TREDescriptionInfo_lengthMatch_get
    if _newclass:lengthMatch = _swig_property(_nitropy.nitf_TREDescriptionInfo_lengthMatch_get, _nitropy.nitf_TREDescriptionInfo_lengthMatch_set)
    __swig_destroy__ = _nitropy.delete_nitf_TREDescriptionInfo
    __del__ = lambda self : None;
nitf_TREDescriptionInfo_swigregister = _nitropy.nitf_TREDescriptionInfo_swigregister
nitf_TREDescriptionInfo_swigregister(nitf_TREDescriptionInfo)

class nitf_TREDescriptionSet(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, nitf_TREDescriptionSet, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, nitf_TREDescriptionSet, name)
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    __swig_setmethods__["defaultIndex"] = _nitropy.nitf_TREDescriptionSet_defaultIndex_set
    __swig_getmethods__["defaultIndex"] = _nitropy.nitf_TREDescriptionSet_defaultIndex_get
    if _newclass:defaultIndex = _swig_property(_nitropy.nitf_TREDescriptionSet_defaultIndex_get, _nitropy.nitf_TREDescriptionSet_defaultIndex_set)
    __swig_setmethods__["descriptions"] = _nitropy.nitf_TREDescriptionSet_descriptions_set
    __swig_getmethods__["descriptions"] = _nitropy.nitf_TREDescriptionSet_descriptions_get
    if _newclass:descriptions = _swig_property(_nitropy.nitf_TREDescriptionSet_descriptions_get, _nitropy.nitf_TREDescriptionSet_descriptions_set)
    __swig_destroy__ = _nitropy.delete_nitf_TREDescriptionSet
    __del__ = lambda self : None;
nitf_TREDescriptionSet_swigregister = _nitropy.nitf_TREDescriptionSet_swigregister
nitf_TREDescriptionSet_swigregister(nitf_TREDescriptionSet)
...
class nitf_TRE(_object):
    ...
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    __swig_setmethods__["length"] = _nitropy.nitf_TRE_length_set
    __swig_getmethods__["length"] = _nitropy.nitf_TRE_length_get
    if _newclass:length = _swig_property(_nitropy.nitf_TRE_length_get, _nitropy.nitf_TRE_length_set)
    __swig_setmethods__["descrip"] = _nitropy.nitf_TRE_descrip_set
    __swig_getmethods__["descrip"] = _nitropy.nitf_TRE_descrip_get
    if _newclass:descrip = _swig_property(_nitropy.nitf_TRE_descrip_get, _nitropy.nitf_TRE_descrip_set)
    __swig_setmethods__["hash"] = _nitropy.nitf_TRE_hash_set
    __swig_getmethods__["hash"] = _nitropy.nitf_TRE_hash_get
    if _newclass:hash = _swig_property(_nitropy.nitf_TRE_hash_get, _nitropy.nitf_TRE_hash_set)
...
class nitf_TRECursor(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, nitf_TRECursor, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, nitf_TRECursor, name)
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    __swig_setmethods__["numItems"] = _nitropy.nitf_TRECursor_numItems_set
    __swig_getmethods__["numItems"] = _nitropy.nitf_TRECursor_numItems_get
    if _newclass:numItems = _swig_property(_nitropy.nitf_TRECursor_numItems_get, _nitropy.nitf_TRECursor_numItems_set)
    __swig_setmethods__["index"] = _nitropy.nitf_TRECursor_index_set
    __swig_getmethods__["index"] = _nitropy.nitf_TRECursor_index_get
    if _newclass:index = _swig_property(_nitropy.nitf_TRECursor_index_get, _nitropy.nitf_TRECursor_index_set)
    __swig_setmethods__["looping"] = _nitropy.nitf_TRECursor_looping_set
    __swig_getmethods__["looping"] = _nitropy.nitf_TRECursor_looping_get
    if _newclass:looping = _swig_property(_nitropy.nitf_TRECursor_looping_get, _nitropy.nitf_TRECursor_looping_set)
    __swig_setmethods__["loop"] = _nitropy.nitf_TRECursor_loop_set
    __swig_getmethods__["loop"] = _nitropy.nitf_TRECursor_loop_get
    if _newclass:loop = _swig_property(_nitropy.nitf_TRECursor_loop_get, _nitropy.nitf_TRECursor_loop_set)
    __swig_setmethods__["loop_idx"] = _nitropy.nitf_TRECursor_loop_idx_set
    __swig_getmethods__["loop_idx"] = _nitropy.nitf_TRECursor_loop_idx_get
    if _newclass:loop_idx = _swig_property(_nitropy.nitf_TRECursor_loop_idx_get, _nitropy.nitf_TRECursor_loop_idx_set)
    __swig_setmethods__["loop_rtn"] = _nitropy.nitf_TRECursor_loop_rtn_set
    __swig_getmethods__["loop_rtn"] = _nitropy.nitf_TRECursor_loop_rtn_get
    if _newclass:loop_rtn = _swig_property(_nitropy.nitf_TRECursor_loop_rtn_get, _nitropy.nitf_TRECursor_loop_rtn_set)
    __swig_setmethods__["tre"] = _nitropy.nitf_TRECursor_tre_set
    __swig_getmethods__["tre"] = _nitropy.nitf_TRECursor_tre_get
    if _newclass:tre = _swig_property(_nitropy.nitf_TRECursor_tre_get, _nitropy.nitf_TRECursor_tre_set)
    __swig_setmethods__["prev_ptr"] = _nitropy.nitf_TRECursor_prev_ptr_set
    __swig_getmethods__["prev_ptr"] = _nitropy.nitf_TRECursor_prev_ptr_get
    if _newclass:prev_ptr = _swig_property(_nitropy.nitf_TRECursor_prev_ptr_get, _nitropy.nitf_TRECursor_prev_ptr_set)
    __swig_setmethods__["desc_ptr"] = _nitropy.nitf_TRECursor_desc_ptr_set
    __swig_getmethods__["desc_ptr"] = _nitropy.nitf_TRECursor_desc_ptr_get
    if _newclass:desc_ptr = _swig_property(_nitropy.nitf_TRECursor_desc_ptr_get, _nitropy.nitf_TRECursor_desc_ptr_set)
    __swig_setmethods__["tag_str"] = _nitropy.nitf_TRECursor_tag_str_set
    __swig_getmethods__["tag_str"] = _nitropy.nitf_TRECursor_tag_str_get
    if _newclass:tag_str = _swig_property(_nitropy.nitf_TRECursor_tag_str_get, _nitropy.nitf_TRECursor_tag_str_set)
    __swig_setmethods__["length"] = _nitropy.nitf_TRECursor_length_set
    __swig_getmethods__["length"] = _nitropy.nitf_TRECursor_length_get
    if _newclass:length = _swig_property(_nitropy.nitf_TRECursor_length_get, _nitropy.nitf_TRECursor_length_set)
    __swig_destroy__ = _nitropy.delete_nitf_TRECursor
    __del__ = lambda self : None;
nitf_TRECursor_swigregister = _nitropy.nitf_TRECursor_swigregister
nitf_TRECursor_swigregister(nitf_TRECursor)

nitf_TRE_foreach = _nitropy.nitf_TRE_foreach
nitf_TRE_begin = _nitropy.nitf_TRE_begin
nitf_TRE_isDone = _nitropy.nitf_TRE_isDone
nitf_TRE_cleanup = _nitropy.nitf_TRE_cleanup
nitf_TRE_iterate = _nitropy.nitf_TRE_iterate
...
nitf_TRE_parse = _nitropy.nitf_TRE_parse
nitf_TRE_print = _nitropy.nitf_TRE_print
nitf_TRE_readField = _nitropy.nitf_TRE_readField
nitf_TRE_getDescriptionSet = _nitropy.nitf_TRE_getDescriptionSet
nitf_TRE_exists = _nitropy.nitf_TRE_exists
nitf_TRE_setValue = _nitropy.nitf_TRE_setValue
nitf_TRE_isSane = _nitropy.nitf_TRE_isSane
nitf_TRE_getRawData = _nitropy.nitf_TRE_getRawData
nitf_TRE_computeLength = _nitropy.nitf_TRE_computeLength
nitf_TRE_flush = _nitropy.nitf_TRE_flush
...
class nitf_ImageReader(_object):
    ...
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    __swig_setmethods__["inputHandle"] = _nitropy.nitf_ImageReader_inputHandle_set
    __swig_getmethods__["inputHandle"] = _nitropy.nitf_ImageReader_inputHandle_get
    if _newclass:inputHandle = _swig_property(_nitropy.nitf_ImageReader_inputHandle_get, _nitropy.nitf_ImageReader_inputHandle_set)
...
class nitf_SegmentReader(_object):
    ...
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    __swig_setmethods__["inputHandle"] = _nitropy.nitf_SegmentReader_inputHandle_set
    __swig_getmethods__["inputHandle"] = _nitropy.nitf_SegmentReader_inputHandle_get
    if _newclass:inputHandle = _swig_property(_nitropy.nitf_SegmentReader_inputHandle_get, _nitropy.nitf_SegmentReader_inputHandle_set)
