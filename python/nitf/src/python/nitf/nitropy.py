...
class nitf_TREEnumerator(_object):
    ...
    __swig_setmethods__["get"] = _nitropy.nitf_TREEnumerator_get_set
    __swig_getmethods__["get"] = _nitropy.nitf_TREEnumerator_get_get
    if _newclass:get = _swig_property(_nitropy.nitf_TREEnumerator_get_get, _nitropy.nitf_TREEnumerator_get_set)
