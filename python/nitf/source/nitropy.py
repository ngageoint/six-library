...
def nitf_System_swap16(*args):
  return _nitropy.nitf_System_swap16(*args)
nitf_System_swap16 = _nitropy.nitf_System_swap16

def nitf_System_swap32(*args):
  return _nitropy.nitf_System_swap32(*args)
nitf_System_swap32 = _nitropy.nitf_System_swap32

def nitf_System_swap64(*args):
  return _nitropy.nitf_System_swap64(*args)
nitf_System_swap64 = _nitropy.nitf_System_swap64

def nitf_System_swap64c(*args):
  return _nitropy.nitf_System_swap64c(*args)
nitf_System_swap64c = _nitropy.nitf_System_swap64c
NITF_MAX_EMESSAGE = _nitropy.NITF_MAX_EMESSAGE
NITF_NO_ERR = _nitropy.NITF_NO_ERR
NITF_ERR_MEMORY = _nitropy.NITF_ERR_MEMORY
NITF_ERR_OPENING_FILE = _nitropy.NITF_ERR_OPENING_FILE
NITF_ERR_READING_FROM_FILE = _nitropy.NITF_ERR_READING_FROM_FILE
NITF_ERR_SEEKING_IN_FILE = _nitropy.NITF_ERR_SEEKING_IN_FILE
NITF_ERR_WRITING_TO_FILE = _nitropy.NITF_ERR_WRITING_TO_FILE
NITF_ERR_STAT_FILE = _nitropy.NITF_ERR_STAT_FILE
NITF_ERR_LOADING_DLL = _nitropy.NITF_ERR_LOADING_DLL
NITF_ERR_UNLOADING_DLL = _nitropy.NITF_ERR_UNLOADING_DLL
NITF_ERR_RETRIEVING_DLL_HOOK = _nitropy.NITF_ERR_RETRIEVING_DLL_HOOK
NITF_ERR_UNINITIALIZED_DLL_READ = _nitropy.NITF_ERR_UNINITIALIZED_DLL_READ
NITF_ERR_INVALID_PARAMETER = _nitropy.NITF_ERR_INVALID_PARAMETER
NITF_ERR_INVALID_OBJECT = _nitropy.NITF_ERR_INVALID_OBJECT
NITF_ERR_INVALID_FILE = _nitropy.NITF_ERR_INVALID_FILE
NITF_ERR_COMPRESSION = _nitropy.NITF_ERR_COMPRESSION
NITF_ERR_DECOMPRESSION = _nitropy.NITF_ERR_DECOMPRESSION
NITF_ERR_PARSING_FILE = _nitropy.NITF_ERR_PARSING_FILE
NITF_ERR_INT_STACK_OVERFLOW = _nitropy.NITF_ERR_INT_STACK_OVERFLOW
NITF_ERR_UNK = _nitropy.NITF_ERR_UNK
class nitf_Error(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, nitf_Error, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, nitf_Error, name)
    __repr__ = _swig_repr
    __swig_setmethods__["message"] = _nitropy.nitf_Error_message_set
    __swig_getmethods__["message"] = _nitropy.nitf_Error_message_get
    if _newclass:message = _swig_property(_nitropy.nitf_Error_message_get, _nitropy.nitf_Error_message_set)
    __swig_setmethods__["file"] = _nitropy.nitf_Error_file_set
    __swig_getmethods__["file"] = _nitropy.nitf_Error_file_get
    if _newclass:file = _swig_property(_nitropy.nitf_Error_file_get, _nitropy.nitf_Error_file_set)
    __swig_setmethods__["line"] = _nitropy.nitf_Error_line_set
    __swig_getmethods__["line"] = _nitropy.nitf_Error_line_get
    if _newclass:line = _swig_property(_nitropy.nitf_Error_line_get, _nitropy.nitf_Error_line_set)
    __swig_setmethods__["func"] = _nitropy.nitf_Error_func_set
    __swig_getmethods__["func"] = _nitropy.nitf_Error_func_get
    if _newclass:func = _swig_property(_nitropy.nitf_Error_func_get, _nitropy.nitf_Error_func_set)
    __swig_setmethods__["level"] = _nitropy.nitf_Error_level_set
    __swig_getmethods__["level"] = _nitropy.nitf_Error_level_get
    if _newclass:level = _swig_property(_nitropy.nitf_Error_level_get, _nitropy.nitf_Error_level_set)
    def __init__(self): 
        this = _nitropy.new_nitf_Error()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _nitropy.delete_nitf_Error
    __del__ = lambda self : None;
nitf_Error_swigregister = _nitropy.nitf_Error_swigregister
nitf_Error_swigregister(nitf_Error)


def nitf_Error_init(*args):
  return _nitropy.nitf_Error_init(*args)
nitf_Error_init = _nitropy.nitf_Error_init

def nitf_Error_flogf(*args):
  return _nitropy.nitf_Error_flogf(*args)
nitf_Error_flogf = _nitropy.nitf_Error_flogf

def nitf_Error_fprintf(*args):
  return _nitropy.nitf_Error_fprintf(*args)
nitf_Error_fprintf = _nitropy.nitf_Error_fprintf

def nitf_Error_initf(*args):
  return _nitropy.nitf_Error_initf(*args)
nitf_Error_initf = _nitropy.nitf_Error_initf

def nitf_Error_print(*args):
  return _nitropy.nitf_Error_print(*args)
nitf_Error_print = _nitropy.nitf_Error_print
NITF_MAX_READ_ATTEMPTS = _nitropy.NITF_MAX_READ_ATTEMPTS

def nitf_IOHandle_create(*args):
  return _nitropy.nitf_IOHandle_create(*args)
nitf_IOHandle_create = _nitropy.nitf_IOHandle_create

def nitf_IOHandle_read(*args):
  return _nitropy.nitf_IOHandle_read(*args)
nitf_IOHandle_read = _nitropy.nitf_IOHandle_read

def nitf_IOHandle_write(*args):
  return _nitropy.nitf_IOHandle_write(*args)
nitf_IOHandle_write = _nitropy.nitf_IOHandle_write

def nitf_IOHandle_seek(*args):
  return _nitropy.nitf_IOHandle_seek(*args)
nitf_IOHandle_seek = _nitropy.nitf_IOHandle_seek

def nitf_IOHandle_tell(*args):
  return _nitropy.nitf_IOHandle_tell(*args)
nitf_IOHandle_tell = _nitropy.nitf_IOHandle_tell

def nitf_IOHandle_getSize(*args):
  return _nitropy.nitf_IOHandle_getSize(*args)
nitf_IOHandle_getSize = _nitropy.nitf_IOHandle_getSize

def nitf_IOHandle_close(*args):
  return _nitropy.nitf_IOHandle_close(*args)
nitf_IOHandle_close = _nitropy.nitf_IOHandle_close
class nitf_IIOInterface(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, nitf_IIOInterface, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, nitf_IIOInterface, name)
    __repr__ = _swig_repr
    __swig_setmethods__["read"] = _nitropy.nitf_IIOInterface_read_set
    __swig_getmethods__["read"] = _nitropy.nitf_IIOInterface_read_get
    if _newclass:read = _swig_property(_nitropy.nitf_IIOInterface_read_get, _nitropy.nitf_IIOInterface_read_set)
    __swig_setmethods__["write"] = _nitropy.nitf_IIOInterface_write_set
    __swig_getmethods__["write"] = _nitropy.nitf_IIOInterface_write_get
    if _newclass:write = _swig_property(_nitropy.nitf_IIOInterface_write_get, _nitropy.nitf_IIOInterface_write_set)
    __swig_setmethods__["seek"] = _nitropy.nitf_IIOInterface_seek_set
    __swig_getmethods__["seek"] = _nitropy.nitf_IIOInterface_seek_get
    if _newclass:seek = _swig_property(_nitropy.nitf_IIOInterface_seek_get, _nitropy.nitf_IIOInterface_seek_set)
    __swig_setmethods__["tell"] = _nitropy.nitf_IIOInterface_tell_set
    __swig_getmethods__["tell"] = _nitropy.nitf_IIOInterface_tell_get
    if _newclass:tell = _swig_property(_nitropy.nitf_IIOInterface_tell_get, _nitropy.nitf_IIOInterface_tell_set)
    __swig_setmethods__["getSize"] = _nitropy.nitf_IIOInterface_getSize_set
    __swig_getmethods__["getSize"] = _nitropy.nitf_IIOInterface_getSize_get
    if _newclass:getSize = _swig_property(_nitropy.nitf_IIOInterface_getSize_get, _nitropy.nitf_IIOInterface_getSize_set)
    __swig_setmethods__["close"] = _nitropy.nitf_IIOInterface_close_set
    __swig_getmethods__["close"] = _nitropy.nitf_IIOInterface_close_get
    if _newclass:close = _swig_property(_nitropy.nitf_IIOInterface_close_get, _nitropy.nitf_IIOInterface_close_set)
    __swig_setmethods__["destruct"] = _nitropy.nitf_IIOInterface_destruct_set
    __swig_getmethods__["destruct"] = _nitropy.nitf_IIOInterface_destruct_get
    if _newclass:destruct = _swig_property(_nitropy.nitf_IIOInterface_destruct_get, _nitropy.nitf_IIOInterface_destruct_set)
    def __init__(self): 
        this = _nitropy.new_nitf_IIOInterface()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _nitropy.delete_nitf_IIOInterface
    __del__ = lambda self : None;
nitf_IIOInterface_swigregister = _nitropy.nitf_IIOInterface_swigregister
nitf_IIOInterface_swigregister(nitf_IIOInterface)

class nitf_IOInterface(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, nitf_IOInterface, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, nitf_IOInterface, name)
    __repr__ = _swig_repr
    __swig_setmethods__["data"] = _nitropy.nitf_IOInterface_data_set
    __swig_getmethods__["data"] = _nitropy.nitf_IOInterface_data_get
    if _newclass:data = _swig_property(_nitropy.nitf_IOInterface_data_get, _nitropy.nitf_IOInterface_data_set)
    __swig_setmethods__["iface"] = _nitropy.nitf_IOInterface_iface_set
    __swig_getmethods__["iface"] = _nitropy.nitf_IOInterface_iface_get
    if _newclass:iface = _swig_property(_nitropy.nitf_IOInterface_iface_get, _nitropy.nitf_IOInterface_iface_set)
    def __init__(self): 
        this = _nitropy.new_nitf_IOInterface()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _nitropy.delete_nitf_IOInterface
    __del__ = lambda self : None;
nitf_IOInterface_swigregister = _nitropy.nitf_IOInterface_swigregister
nitf_IOInterface_swigregister(nitf_IOInterface)


def nitf_IOInterface_read(*args):
  return _nitropy.nitf_IOInterface_read(*args)
nitf_IOInterface_read = _nitropy.nitf_IOInterface_read

def nitf_IOInterface_write(*args):
  return _nitropy.nitf_IOInterface_write(*args)
nitf_IOInterface_write = _nitropy.nitf_IOInterface_write

def nitf_IOInterface_seek(*args):
  return _nitropy.nitf_IOInterface_seek(*args)
nitf_IOInterface_seek = _nitropy.nitf_IOInterface_seek

def nitf_IOInterface_tell(*args):
  return _nitropy.nitf_IOInterface_tell(*args)
nitf_IOInterface_tell = _nitropy.nitf_IOInterface_tell

def nitf_IOInterface_getSize(*args):
  return _nitropy.nitf_IOInterface_getSize(*args)
nitf_IOInterface_getSize = _nitropy.nitf_IOInterface_getSize

def nitf_IOInterface_close(*args):
  return _nitropy.nitf_IOInterface_close(*args)
nitf_IOInterface_close = _nitropy.nitf_IOInterface_close

def nitf_IOInterface_destruct(*args):
  return _nitropy.nitf_IOInterface_destruct(*args)
nitf_IOInterface_destruct = _nitropy.nitf_IOInterface_destruct

def nitf_IOHandleAdaptor_construct(*args):
  return _nitropy.nitf_IOHandleAdaptor_construct(*args)
nitf_IOHandleAdaptor_construct = _nitropy.nitf_IOHandleAdaptor_construct
...
NITF_DATA_RETAIN_OWNER = _nitropy.NITF_DATA_RETAIN_OWNER
NITF_DATA_ADOPT = _nitropy.NITF_DATA_ADOPT
class nitf_HashTable(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, nitf_HashTable, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, nitf_HashTable, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_setmethods__["buckets"] = _nitropy.nitf_HashTable_buckets_set
    __swig_getmethods__["buckets"] = _nitropy.nitf_HashTable_buckets_get
    if _newclass:buckets = _swig_property(_nitropy.nitf_HashTable_buckets_get, _nitropy.nitf_HashTable_buckets_set)
    __swig_setmethods__["nbuckets"] = _nitropy.nitf_HashTable_nbuckets_set
    __swig_getmethods__["nbuckets"] = _nitropy.nitf_HashTable_nbuckets_get
    if _newclass:nbuckets = _swig_property(_nitropy.nitf_HashTable_nbuckets_get, _nitropy.nitf_HashTable_nbuckets_set)
    __swig_setmethods__["adopt"] = _nitropy.nitf_HashTable_adopt_set
    __swig_getmethods__["adopt"] = _nitropy.nitf_HashTable_adopt_get
    if _newclass:adopt = _swig_property(_nitropy.nitf_HashTable_adopt_get, _nitropy.nitf_HashTable_adopt_set)
    __swig_setmethods__["hash"] = _nitropy.nitf_HashTable_hash_set
    __swig_getmethods__["hash"] = _nitropy.nitf_HashTable_hash_get
    if _newclass:hash = _swig_property(_nitropy.nitf_HashTable_hash_get, _nitropy.nitf_HashTable_hash_set)
    __swig_destroy__ = _nitropy.delete_nitf_HashTable
    __del__ = lambda self : None;
nitf_HashTable_swigregister = _nitropy.nitf_HashTable_swigregister
nitf_HashTable_swigregister(nitf_HashTable)

class nitf_HashTableIterator(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, nitf_HashTableIterator, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, nitf_HashTableIterator, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_setmethods__["hash"] = _nitropy.nitf_HashTableIterator_hash_set
    __swig_getmethods__["hash"] = _nitropy.nitf_HashTableIterator_hash_get
    if _newclass:hash = _swig_property(_nitropy.nitf_HashTableIterator_hash_get, _nitropy.nitf_HashTableIterator_hash_set)
    __swig_setmethods__["curBucket"] = _nitropy.nitf_HashTableIterator_curBucket_set
    __swig_getmethods__["curBucket"] = _nitropy.nitf_HashTableIterator_curBucket_get
    if _newclass:curBucket = _swig_property(_nitropy.nitf_HashTableIterator_curBucket_get, _nitropy.nitf_HashTableIterator_curBucket_set)
    __swig_setmethods__["listIter"] = _nitropy.nitf_HashTableIterator_listIter_set
    __swig_getmethods__["listIter"] = _nitropy.nitf_HashTableIterator_listIter_get
    if _newclass:listIter = _swig_property(_nitropy.nitf_HashTableIterator_listIter_get, _nitropy.nitf_HashTableIterator_listIter_set)
    __swig_destroy__ = _nitropy.delete_nitf_HashTableIterator
    __del__ = lambda self : None;
nitf_HashTableIterator_swigregister = _nitropy.nitf_HashTableIterator_swigregister
nitf_HashTableIterator_swigregister(nitf_HashTableIterator)


def nitf_HashTable_construct(*args):
  return _nitropy.nitf_HashTable_construct(*args)
nitf_HashTable_construct = _nitropy.nitf_HashTable_construct

def nitf_HashTable_clone(*args):
  return _nitropy.nitf_HashTable_clone(*args)
nitf_HashTable_clone = _nitropy.nitf_HashTable_clone

def nitf_HashTable_setPolicy(*args):
  return _nitropy.nitf_HashTable_setPolicy(*args)
nitf_HashTable_setPolicy = _nitropy.nitf_HashTable_setPolicy

def nitf_HashTable_remove(*args):
  return _nitropy.nitf_HashTable_remove(*args)
nitf_HashTable_remove = _nitropy.nitf_HashTable_remove

def nitf_HashTable_initDefaults(*args):
  return _nitropy.nitf_HashTable_initDefaults(*args)
nitf_HashTable_initDefaults = _nitropy.nitf_HashTable_initDefaults

def nitf_HashTable_destruct(*args):
  return _nitropy.nitf_HashTable_destruct(*args)
nitf_HashTable_destruct = _nitropy.nitf_HashTable_destruct

def nitf_HashTable_exists(*args):
  return _nitropy.nitf_HashTable_exists(*args)
nitf_HashTable_exists = _nitropy.nitf_HashTable_exists

def nitf_HashTable_print(*args):
  return _nitropy.nitf_HashTable_print(*args)
nitf_HashTable_print = _nitropy.nitf_HashTable_print

def nitf_HashTable_foreach(*args):
  return _nitropy.nitf_HashTable_foreach(*args)
nitf_HashTable_foreach = _nitropy.nitf_HashTable_foreach

def nitf_HashTable_insert(*args):
  return _nitropy.nitf_HashTable_insert(*args)
nitf_HashTable_insert = _nitropy.nitf_HashTable_insert

def nitf_HashTable_find(*args):
  return _nitropy.nitf_HashTable_find(*args)
nitf_HashTable_find = _nitropy.nitf_HashTable_find

def nitf_HashTableIterator_equals(*args):
  return _nitropy.nitf_HashTableIterator_equals(*args)
nitf_HashTableIterator_equals = _nitropy.nitf_HashTableIterator_equals

def nitf_HashTableIterator_notEqualTo(*args):
  return _nitropy.nitf_HashTableIterator_notEqualTo(*args)
nitf_HashTableIterator_notEqualTo = _nitropy.nitf_HashTableIterator_notEqualTo

def nitf_HashTable_begin(*args):
  return _nitropy.nitf_HashTable_begin(*args)
nitf_HashTable_begin = _nitropy.nitf_HashTable_begin

def nitf_HashTable_end(*args):
  return _nitropy.nitf_HashTable_end(*args)
nitf_HashTable_end = _nitropy.nitf_HashTable_end

def nitf_HashTableIterator_increment(*args):
  return _nitropy.nitf_HashTableIterator_increment(*args)
nitf_HashTableIterator_increment = _nitropy.nitf_HashTableIterator_increment

def nitf_HashTableIterator_get(*args):
  return _nitropy.nitf_HashTableIterator_get(*args)
nitf_HashTableIterator_get = _nitropy.nitf_HashTableIterator_get
class nitf_Pair(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, nitf_Pair, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, nitf_Pair, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_setmethods__["key"] = _nitropy.nitf_Pair_key_set
    __swig_getmethods__["key"] = _nitropy.nitf_Pair_key_get
    if _newclass:key = _swig_property(_nitropy.nitf_Pair_key_get, _nitropy.nitf_Pair_key_set)
    __swig_setmethods__["data"] = _nitropy.nitf_Pair_data_set
    __swig_getmethods__["data"] = _nitropy.nitf_Pair_data_get
    if _newclass:data = _swig_property(_nitropy.nitf_Pair_data_get, _nitropy.nitf_Pair_data_set)
    __swig_destroy__ = _nitropy.delete_nitf_Pair
    __del__ = lambda self : None;
nitf_Pair_swigregister = _nitropy.nitf_Pair_swigregister
nitf_Pair_swigregister(nitf_Pair)


def nitf_Pair_init(*args):
  return _nitropy.nitf_Pair_init(*args)
nitf_Pair_init = _nitropy.nitf_Pair_init

def nitf_Pair_copy(*args):
  return _nitropy.nitf_Pair_copy(*args)
nitf_Pair_copy = _nitropy.nitf_Pair_copy
