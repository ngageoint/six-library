...
typedef NRT_BOOL    (*J2K_ICONTAINER_CAN_READ_TILES)(J2K_USER_DATA*, nrt_Error*);
...
{
    J2K_ICONTAINER_CAN_READ_TILES canReadTiles;
...
NRTAPI(NRT_BOOL) j2k_Container_canReadTiles(j2k_Container*, nrt_Error*);
