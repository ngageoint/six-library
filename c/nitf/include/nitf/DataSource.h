 ...
 */
typedef nitf_Off (*NITF_IDATASOURCE_GET_SIZE) (NITF_DATA *, nitf_Error *error);
 ...
 */
typedef NITF_BOOL (*NITF_IDATASOURCE_SET_SIZE) (NITF_DATA *, nitf_Off size, nitf_Error *error);
