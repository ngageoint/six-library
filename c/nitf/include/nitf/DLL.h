...
#ifndef __NITF_DLL_H__
#define __NITF_DLL_H__
 ...
 *  calls nitf_DLL_unload().  NULLs the pointer
 ...
 *  \return A status to be tested using NITF_FAILURE()
 */
