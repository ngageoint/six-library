...
static nitf_TREDescription description[] = {
    {NITF_BCS_N, 2, "Number of sets of sensor parameters",
     "NUMSNS", NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE,
     NULL, NULL},
    ...
    {NITF_BCS_N, 2, "Number of Points in the Bounding Polygon",
     "NUM_PTS", NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE,
     NULL, NULL},
    ...
    {NITF_ENDLOOP, 0, NULL, NULL},
    {NITF_BCS_A, 3,
     "Resolutions and ground sample distances units", "UNIRES",
     NITF_VAL_BCS_A_PLUS, NITF_NO_RANGE, NULL, NULL},
    ...
    {NITF_BCS_A, 18, "Acquisition Date and Time", "ACT",
     NITF_VAL_BCS_A_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_A, 3, "Unit of the Scene Orientation Angle",
     "UNINOA", NITF_VAL_BCS_A_PLUS, NITF_NO_RANGE,
     NULL, NULL},
    {NITF_BCS_N, 7, "Scene Orientation Angle", "NOA",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_A, 3, "Unit of Incidence Angle", "UNIANG",
     NITF_VAL_BCS_A_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_N, 7, "Incidence Angle at Original Scene Center",
     "ANG", NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL,
     NULL},
    {NITF_BCS_A, 3, "Unit of Altitude", "UNIALT",
     NITF_VAL_BCS_A_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_N, 9, "Altitude of Sensor", "ALT",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_N, 10, "WGS84 Longitude of Original Scene Centre",
     "LONSCC", NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE,
     NULL, NULL},
    {NITF_BCS_N, 10, "WGS84 Latitude of Original Scene Centre",
     "LATSCC", NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE,
     NULL, NULL},
    ...
    {NITF_BCS_N, 20, "Auxiliary Parameter Real Value", "APR",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_A, 20,
     "Auxiliary Parameter Characters String Value", "APA",
     NITF_VAL_BCS_A_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_ENDLOOP, 0, NULL, NULL},
    {NITF_ENDLOOP, 0, NULL, NULL},
