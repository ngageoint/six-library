...
static nitf_TREDescription description[] = {
    ...
    {NITF_BCS_N, 5, "Complex Imagery Compressed Bits per Pixel", "CMPLX_IC_BPP",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_A, 3, "Type of Weighting", "CMPX_WEIGHT",
     NITF_VAL_BCS_A_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_N, 2, "Azimuth Sidelobe Level", "CMPLX_AZ_SLL",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_N, 2, "Range Sidelobe Level", "CMPLX_RG_SLL",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    ...
    {NITF_BCS_N, 12, "Lon of Patch Corner, upper left", "CG_PATCH_LGCORUL",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_N, 11, "Lat of Patch Corner, upper right", "CG_PATCH_LTC_ORUR",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_N, 12, "Lon of Patch Corner, upper right", "CG_PATCH_LGC_ORUR",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_N, 11, "Lat of Patch Corner, lower right", "CG_PATCH_LTC_ORLR",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_N, 12, "Lon of Patch Corner, lower right", "CG_PATCH_LGC_ORLR",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_N, 11, "Lat of Patch Corner, lower left", "CG_PATCH_LTC_ORLL",
     NITF_VAL_BCS_N_PLUS, NITF_NO_RANGE, NULL, NULL},
    ...
    {NITF_BCS_A, 23, "MGRS Image Lower RightCorn", "CG_MGRSCORLR",
     NITF_VAL_BCS_A_PLUS, NITF_NO_RANGE, NULL, NULL},
    {NITF_BCS_A, 23, "MGRS Image Lower Left Corn", "CG_MGRSCORLR",
     NITF_VAL_BCS_A_PLUS, NITF_NO_RANGE, NULL, NULL},
