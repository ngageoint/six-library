...
NRTPRIV(NRT_BOOL) preOrder(nrt_TreeNode* node, 
...
NRTPRIV(NRT_BOOL) postOrder(nrt_TreeNode* node, 
                              NRT_TREE_TRAVERSER onNode,
                              NRT_DATA* userData,
                              int depth,
                              nrt_Error* error)
...
{
    nrt_TreeNode *node =
        (nrt_TreeNode *) NRT_MALLOC(sizeof(nrt_TreeNode));
