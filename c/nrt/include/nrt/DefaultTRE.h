...
#ifndef __NRT_DEFAULT_TRE_H__
#define __NRT_DEFAULT_TRE_H__

#include "nrt/System.h"
#include "nrt/HashTable.h"
#include "nrt/IOHandle.h"
#include "nrt/TRE.h"
#include "nrt/TREUtils.h"

NRT_CXX_GUARD

struct _NRT_Record;
/*!
 *  \fn nrt_DefaultTRE_handler
 ...
 *
 */
NRTAPI(nrt_TREHandler*) nrt_DefaultTRE_handler(nrt_Error * error);
