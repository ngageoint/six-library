...
typedef NRT_BOOL (*NRT_IO_INTERFACE_READ)(NRT_DATA*, char*,size_t, nrt_Error*);
typedef NRT_BOOL (*NRT_IO_INTERFACE_WRITE)(NRT_DATA*, const char*, size_t, nrt_Error*);
 ...
 */
NRTAPI(NRT_BOOL) nrt_IOInterface_read(nrt_IOInterface*, char *buf,
