...
typedef NRT_BOOL (*NRT_IO_INTERFACE_READ) (NRT_DATA* data,
                                             char *buf, size_t size,
                                             nrt_Error *error);

typedef NRT_BOOL (*NRT_IO_INTERFACE_WRITE)(NRT_DATA* data,
                                             const char *buf, size_t size,
                                             nrt_Error * error);

typedef nrt_Off    (*NRT_IO_INTERFACE_SEEK)(NRT_DATA* data,
                                              nrt_Off offset, int whence,
                                              nrt_Error* error);

typedef nrt_Off     (*NRT_IO_INTERFACE_TELL)(NRT_DATA* data,
                                               nrt_Error * error);

typedef nrt_Off     (*NRT_IO_INTERFACE_GET_SIZE)(NRT_DATA* data,
                                                   nrt_Error * error);

typedef NRT_BOOL (*NRT_IO_INTERFACE_CLOSE)(NRT_DATA* data,
                                             nrt_Error* error);
