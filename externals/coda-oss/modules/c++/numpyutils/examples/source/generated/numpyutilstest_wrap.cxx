...
#define SWIGTYPE_p_uint16_t swig_types[16]
#define SWIGTYPE_p_uint32_t swig_types[17]
#define SWIGTYPE_p_uint64_t swig_types[18]
...
/*-----------------------------------------------
              @(target):= _numpyutilstest.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__numpyutilstest

#else
#  define SWIG_init    init_numpyutilstest

#endif
#define SWIG_name    "_numpyutilstest"
...
SWIGINTERN PyObject *_wrap_elementDoubleTest__SWIG_0(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_elementDoubleTest__SWIG_1(PyObject *SWIGUNUSEDPARM(self), Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  PyObject *arg1 = (PyObject *) 0 ;
  PyObject *result = 0 ;
...
SWIGINTERN PyObject *_wrap_elementDoubleTest(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "elementDoubleTest", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
    int _v;
    _v = (argv[0] != 0);
    if (_v) {
      return _wrap_elementDoubleTest__SWIG_1(self, argc, argv);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      _v = (argv[1] != 0);
      if (_v) {
        return _wrap_elementDoubleTest__SWIG_0(self, argc, argv);
      }
    }
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'elementDoubleTest'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    elementDoubleTest(PyObject *,PyObject *)\n"
    "    elementDoubleTest(PyObject *)\n");
  return 0;
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "elementDoubleTest", _wrap_elementDoubleTest, METH_VARARGS, "elementDoubleTest(PyObject * inputNPArray, PyObject * outputNPArray=Py_None) -> PyObject"},
	 { NULL, NULL, 0, NULL }
};
