...
inline auto c_str_(const std::wstring& s)
{
    #if _WIN32
...
inline auto c_str_(const std::string& s)
{
    #if _WIN32
    return str::c_str<str::W1252string>(s); // std::string is Windows-1252 on Windows
    #else
