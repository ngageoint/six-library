...
class FileHandler(StreamHandler):
    ...
    def __init__(self, *args):
        """
        __init__(logging::FileHandler self, sys::Filesystem::path const & fname, LogLevel level, int creationFlags) -> FileHandler
        __init__(logging::FileHandler self, sys::Filesystem::path const & fname, LogLevel level) -> FileHandler
        __init__(logging::FileHandler self, sys::Filesystem::path const & fname) -> FileHandler
        """
