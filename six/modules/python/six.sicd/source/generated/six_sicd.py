...
class ScopedCloneableImageData(_object):
    ...
    def __eq__(self, rhs):
        """__eq__(ScopedCloneableImageData self, ImageData rhs) -> bool"""
        return _six_sicd.ScopedCloneableImageData___eq__(self, rhs)


    def __ne__(self, rhs):
        """__ne__(ScopedCloneableImageData self, ImageData rhs) -> bool"""
        return _six_sicd.ScopedCloneableImageData___ne__(self, rhs)
