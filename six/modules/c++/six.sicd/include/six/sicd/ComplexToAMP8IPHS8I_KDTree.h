...
*
*/
#ifndef SIX_six_sicd_ComplexToAMP8IPHS8I_KDTree_h_INCLUDED_
#define SIX_six_sicd_ComplexToAMP8IPHS8I_KDTree_h_INCLUDED_
#pragma once
 ...
 */
class ComplexToAMP8IPHS8I_KDTree final
{
    explicit ComplexToAMP8IPHS8I_KDTree(const six::AmplitudeTable* pAmplitudeTable);
...
public:
     ...
     */
    explicit ComplexToAMP8IPHS8I_KDTree();
    explicit ComplexToAMP8IPHS8I_KDTree(const six::AmplitudeTable&);
...
#endif // SIX_six_sicd_ComplexToAMP8IPHS8I_KDTree_h_INCLUDED_
