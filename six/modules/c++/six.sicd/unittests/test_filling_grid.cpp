...
TEST_CASE(DefaultFromRMAT)
{
    ...
    TEST_ASSERT_EQ(six::Enum::toString(grid.imagePlane), "SLANT");
    TEST_ASSERT_EQ(grid.imagePlane, six::ComplexImagePlaneType::SLANT);
    TEST_ASSERT_EQ(six::Enum::toString(grid.type), "XCTYAT");
...
TEST_CASE(DefaultFromRMCR)
{
    ...
    TEST_ASSERT_EQ(six::Enum::toString(grid.imagePlane), "SLANT");
    TEST_ASSERT_EQ(grid.imagePlane, six::ComplexImagePlaneType::SLANT);
    TEST_ASSERT_EQ(six::Enum::toString(grid.type), "XRGYCR");
...
TEST_CASE(DefaultFromPFA)
{
    ...
    TEST_ASSERT_EQ(six::Enum::toString(grid.type), "RGAZIM");
