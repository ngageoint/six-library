    ...
    XMLElem imageFormationXML) const
{
    ...
    {
        throw except::Exception(Ctxt(FmtX("[RcvChanProc] is a manditory field in ImageFormation in %s", strVersion)));
    }
}
    ...
    XMLElem pcXML) const
{
    ...
    {
        throw except::Exception(Ctxt(FmtX("[Distortion] is a maditory field of ImageFormation in %s", strVersion)));
    }
}
