...
*
*/
#include "six/sicd/ComplexToAMP8IPHS8I_KDTree.h"
...
ComplexToAMP8IPHS8I_KDTree::ComplexToAMP8IPHS8I_KDTree(const six::AmplitudeTable *pAmplitudeTable)
{
...
ComplexToAMP8IPHS8I_KDTree::ComplexToAMP8IPHS8I_KDTree(const six::AmplitudeTable& amplitudeTable) : ComplexToAMP8IPHS8I_KDTree(&amplitudeTable) {}
ComplexToAMP8IPHS8I_KDTree::ComplexToAMP8IPHS8I_KDTree() : ComplexToAMP8IPHS8I_KDTree(nullptr /*pAmplitudeTable*/) {}
...
ImageData::AMP8I_PHS8I_t ComplexToAMP8IPHS8I_KDTree::nearest_neighbor(const std::complex<float> &v) const
{
