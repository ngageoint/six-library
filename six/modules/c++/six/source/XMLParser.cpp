...
xml_lite::Element& XMLParser::getFirstAndOnly(const xml_lite::Element& parent, const std::string& tag)
{
    return XmlLite::getFirstAndOnly(parent, tag);
}
XMLElem XMLParser::getFirstAndOnly(const xml_lite::Element* parent, const std::string& tag)
{
    assert(parent != nullptr);
    return & getFirstAndOnly(*parent, tag);
}

xml_lite::Element* XMLParser::getOptional(const xml_lite::Element& parent, const std::string& tag)
{
    return XmlLite::getOptional(parent, tag);
}
XMLElem XMLParser::getOptional(const xml_lite::Element* parent, const std::string& tag)
{
    assert(parent != nullptr);
...
bool XMLParser::parseDouble(const xml_lite::Element& element, double& value) const
{
...
void XMLParser::parseDouble(const xml_lite::Element* element, std::optional<double>& value) const
{
    assert(element != nullptr);
    mXmlLite.parseDouble(*element, value);
}

bool XMLParser::parseOptionalDouble(const xml_lite::Element* parent, const std::string& tag, double& value) const
{
    assert(parent != nullptr);
    return mXmlLite.parseOptionalDouble(*parent, tag, value);
}
bool XMLParser::parseOptionalDouble(const xml_lite::Element* parent, const std::string& tag, std::optional<double>& value) const
{
    assert(parent != nullptr);
    return mXmlLite.parseOptionalDouble(*parent, tag, value);
}

void XMLParser::parseComplex(const xml_lite::Element* element, std::complex<double>& value) const
{
    assert(element != nullptr);
    mXmlLite.parseComplex(*element, value);
}

void XMLParser::parseString(const xml_lite::Element& element, std::string& value) const
{
...
bool XMLParser::parseOptionalString(const xml_lite::Element& parent, const std::string& tag, std::string& value) const
{
