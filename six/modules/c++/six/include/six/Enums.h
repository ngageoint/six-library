...
static_assert(six::DualPolarizationType::V_E == 22, "six::DualPolarizationType is wrong!");
static_assert(six::DualPolarizationType::V_LHC == 5, "six::DualPolarizationType is wrong!");
static_assert(six::DualPolarizationType::LHC_E == 66, "six::DualPolarizationType is wrong!");
