...
TEST_CASE(testPvpOptional)
{
    ...
    pvp.setParameters(1, 30, "F8", "Param1");
    pvp.setParameters(1, 31, "S10", "Param2");
    pvp.setParameters(1, 32, "CI16", "Param3");
    cphd::PVPBlock pvpBlock(NUM_CHANNELS,
                            std::vector<size_t>(NUM_CHANNELS, NUM_VECTORS),
                            pvp);
...
TEST_CASE(testPvpThrow)
{
    ...
    pvp.setParameters(1, 30, "F8", "Param1");
    pvp.setParameters(1, 31, "F8", "Param2");
    TEST_EXCEPTION(pvp.setParameters(1, 30, "F8", "Param1")); //Rewriting to existing memory block
    TEST_EXCEPTION(pvp.setParameters(1, 30, "X=F8;YF8;", "Param1")); //
    TEST_EXCEPTION(pvp.setParameters(1, 30, "X=F8;Y=F8;Z=", "Param1"));
    ...
    cphd::Pvp pvp2;
    cphd::setPVPXML(pvp2);
    pvp2.setParameters(1, 27, "F8", "Param1");
...
TEST_CASE(testPvpEquality)
{
    ...
    pvp1.setParameters(1, 30, "F8", "Param1");
    pvp1.setParameters(1, 31, "CI8", "Param2");
    ...
    pvp2.setParameters(1, 30, "F8", "Param1");
    pvp2.setParameters(1, 31, "CI8", "Param2");
    cphd::PVPBlock pvpBlock2(NUM_CHANNELS,
                             std::vector<size_t>(NUM_CHANNELS, NUM_VECTORS),
                             pvp2);
