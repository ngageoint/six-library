...
TEST_CASE(testOptional)
{
    ...
    TEST_ASSERT_EQ(errorParams.monostatic->posVelErr.PositionDecorr().get().corrCoefZero, 0.5);
    TEST_ASSERT_EQ(errorParams.monostatic->posVelErr.PositionDecorr().get().decorrRate, 1.0);
