...
#ifndef __CPHD_VBM_H__
#define __CPHD_VBM_H__
...
//  the cphd::VectorParameters info (for the map of available VBM entries)
...
public:
    ...
    */
    ...
    // startVBM = cphd header keyword "VB_BYTE_OFFSET"
    // sizeVBM = cphd header keyword "VB_DATA_SIZE"
