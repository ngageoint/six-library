...
private:
    ...
    XMLElem toXML(const std::optional<PolRef>&, const std::string& name, xml::lite::Element& parent);
    ...
    void parsePolRef(const xml::lite::Element& polarizationXML, const std::string& tag, std::optional<PolRef>&) const;
