...
{
    return xml::lite::Uri("urn:us:gov:ic:ism:13"); //return xml::lite::Uri("urn:us:gov:ic:ism:201609");
}
        ...
        XMLElem parent) const
{
    ...
    // SIDD 3.0 is tied to IC-ISM v13 // v201609
    classElem.attribute("DESVersion") = "13"; // 201609
