...
#ifndef __CPHD03_WIDEBAND_H__
#define __CPHD03_WIDEBAND_H__
...
public:
     ...
     * \param startWB CPHD header keyword "CPHD03_BYTE_OFFSET"
     * \param sizeWB CPHD header keyword "CPHD03_DATA_SIZE"
     */
    Wideband(const std::string& pathname,
             const cphd03::Data& data,
             sys::Off_T startWB,
             sys::Off_T sizeWB);
...
private:
    ...
    cphd03::Data mData;                 // contains numChan, numVectors
